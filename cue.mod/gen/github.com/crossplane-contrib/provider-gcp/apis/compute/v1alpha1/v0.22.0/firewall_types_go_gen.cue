...
#FirewallParameters: {
	...
	// +optional
	sourceRanges?: [...string] @go(SourceRanges,[]string)
	...
	// supported.
	// +optional
	destinationRanges?: [...string] @go(DestinationRanges,[]string)
	...
	// +optional
	sourceTags?: [...string] @go(SourceTags,[]string)
	...
	// +optional
	targetTags?: [...string] @go(TargetTags,[]string)
	...
	// +optional
	sourceServiceAccounts?: [...string] @go(SourceServiceAccounts,[]string)
	...
	// +optional
	targetServiceAccounts?: [...string] @go(TargetServiceAccounts,[]string)
	...
	// +optional
	allowed?: [...null | #FirewallAllowed] @go(Allowed,[]*FirewallAllowed)
	...
	// connection.
	// +optional
	denied?: [...null | #FirewallDenied] @go(Denied,[]*FirewallDenied)
	...
	// Stackdriver.
	// +optional
	logConfig?: null | #FirewallLogConfig @go(LogConfig,*FirewallLogConfig)
}
