...
#Policy: {
	...
	// policy.
	auditConfigs?: [...null | #AuditConfig] @go(AuditConfigs,[]*AuditConfig)
	...
	bindings?: [...null | #Binding] @go(Bindings,[]*Binding)
}
...
#AuditConfig: {
	...
	// permission.
	auditLogConfigs?: [...null | #AuditLogConfig] @go(AuditLogConfigs,[]*AuditLogConfig)
...
#AuditLogConfig: {
	...
	exemptedMembers?: [...string] @go(ExemptedMembers,[]string)
...
#Binding: {
	...
	// examined
	// independently.
	condition?: null | #Expr @go(Condition,*Expr)
