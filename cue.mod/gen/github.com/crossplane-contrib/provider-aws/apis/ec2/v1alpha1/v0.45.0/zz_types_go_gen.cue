...
#DNSOptions: {
	...
	privateDNSOnlyForInboundResolverEndpoint?: null | bool   @go(PrivateDNSOnlyForInboundResolverEndpoint,*bool)
}
...
#EC2InstanceConnectEndpoint: {
	availabilityZone?: null | string @go(AvailabilityZone,*string)
	dnsName?:          null | string @go(DNSName,*string)
	fipsDNSName?:      null | string @go(FipsDNSName,*string)
	ownerID?:          null | string @go(OwnerID,*string)
	preserveClientIP?: null | bool   @go(PreserveClientIP,*bool)
...
#IPAM: {
	...
	ownerID?:                           null | string @go(OwnerID,*string)
	resourceDiscoveryAssociationCount?: null | int64  @go(ResourceDiscoveryAssociationCount,*int64)
...
#IPAMDiscoveredAccount: {
	...
	discoveryRegion?: null | string @go(DiscoveryRegion,*string)
}
...
#IPAMPoolCIDR: {
	cidr?:          null | string @go(CIDR,*string)
	netmaskLength?: null | int64  @go(NetmaskLength,*int64)
}
...
#IPAMResourceDiscovery: {
	description?:                 null | string @go(Description,*string)
	ipamResourceDiscoveryARN?:    null | string @go(IPAMResourceDiscoveryARN,*string)
	ipamResourceDiscoveryRegion?: null | string @go(IPAMResourceDiscoveryRegion,*string)
...
#IPAMResourceDiscoveryAssociation: {
	ipamRegion?:                          null | string @go(IPAMRegion,*string)
	ipamResourceDiscoveryAssociationARN?: null | string @go(IPAMResourceDiscoveryAssociationARN,*string)
	isDefault?:                           null | bool   @go(IsDefault,*bool)
	ownerID?:                             null | string @go(OwnerID,*string)
	tags?: [...null | #Tag] @go(Tags,[]*Tag)
}
...
#InstanceIPv6Address: {
	...
	isPrimaryIPv6?: null | bool   @go(IsPrimaryIPv6,*bool)
}
...
#InstanceNetworkInterfaceSpecification: {
	...
	networkCardIndex?:   null | int64  @go(NetworkCardIndex,*int64)
	networkInterfaceID?: null | string @go(NetworkInterfaceID,*string)
	primaryIPv6?:        null | bool   @go(PrimaryIPv6,*bool)
	privateIPAddress?:   null | string @go(PrivateIPAddress,*string)
...
// +kubebuilder:skipversion
#MaintenanceDetails: {
	pendingMaintenance?: null | string @go(PendingMaintenance,*string)
}
...
#ModifyVPNTunnelOptionsSpecification: {
	...
	enableTunnelLifecycleControl?: null | bool   @go(EnableTunnelLifecycleControl,*bool)
...
// +kubebuilder:skipversion
#RuleGroupTypePair: {
	ruleGroupType?: null | string @go(RuleGroupType,*string)
}
...
// +kubebuilder:skipversion
#SubnetConfiguration: {
	ipv4?:     null | string @go(IPv4,*string)
	ipv6?:     null | string @go(IPv6,*string)
	subnetID?: null | string @go(SubnetID,*string)
}
...
#VerifiedAccessLogOptions: {
	includeTrustContext?: null | bool   @go(IncludeTrustContext,*bool)
	logVersion?:          null | string @go(LogVersion,*string)
}
