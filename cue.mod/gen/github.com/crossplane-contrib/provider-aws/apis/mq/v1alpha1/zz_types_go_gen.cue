...
#DataReplicationMetadataOutput: {
	...
	dataReplicationCounterpart?: null | #DataReplicationCounterpart @go(DataReplicationCounterpart,*DataReplicationCounterpart)
	dataReplicationRole?:        null | string                      @go(DataReplicationRole,*string)
}
