...
#InvokeWithResponseStreamCompleteEvent: {
	errorCode?:    null | string @go(ErrorCode,*string)
	errorDetails?: null | string @go(ErrorDetails,*string)
	logResult?:    null | string @go(LogResult,*string)
}
...
#RuntimeVersionConfig: {
	...
	error?:             null | #RuntimeVersionError @go(Error,*RuntimeVersionError)
	runtimeVersionARN?: null | string               @go(RuntimeVersionARN,*string)
}
