...
#JobRun_SDK: {
	...
	retryPolicyExecution?: null | #RetryPolicyExecution @go(RetryPolicyExecution,*RetryPolicyExecution)
...
#RetryPolicyConfiguration: {
	maxAttempts?: null | int64 @go(MaxAttempts,*int64)
}

// +kubebuilder:skipversion
#RetryPolicyExecution: {
	currentAttemptCount?: null | int64 @go(CurrentAttemptCount,*int64)
}
