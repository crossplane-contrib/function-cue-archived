...
#CustomComputeEnvironmentParameters: {
	...
	instanceRole?: null | string @go(InstanceRole,*string)
	...
	spotIamFleetRole?: null | string @go(SpotIAMFleetRole,*string)
	...
	// in the Batch User Guide.
	updateToLatestImageVersion?: null | bool @go(UpdateToLatestImageVersion,*bool)
}
...
#CustomJobQueueParameters: {
	...
	computeEnvironmentOrder: [...#CustomComputeEnvironmentOrder] @go(ComputeEnvironmentOrder,[]CustomComputeEnvironmentOrder)
}

// CustomComputeEnvironmentOrder includes custom additional fields for ComputeEnvironmentOrder
#CustomComputeEnvironmentOrder: {
	...
	computeEnvironment?: string @go(ComputeEnvironment)
