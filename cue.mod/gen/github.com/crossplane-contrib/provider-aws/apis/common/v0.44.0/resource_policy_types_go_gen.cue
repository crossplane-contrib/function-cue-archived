...
#ResourcePolicy: {
	...
	// +optional
	statements?: [...#ResourcePolicyStatement] @go(Statements,[]ResourcePolicyStatement)
}

// ResourcePolicyStatement defines an individual statement within the
// ResourcePolicyBody
#ResourcePolicyStatement: {
	...
	// +optional
	principal?: null | #ResourcePrincipal @go(Principal,*ResourcePrincipal)

	// Used with the resource policy to specify the users which are not included
	// in this policy
	// +optional
	notPrincipal?: null | #ResourcePrincipal @go(NotPrincipal,*ResourcePrincipal)
...
// ResourcePrincipal defines the principal users affected by
// the ResourcePolicyStatement
// Please see the AWS resource docs for more information
