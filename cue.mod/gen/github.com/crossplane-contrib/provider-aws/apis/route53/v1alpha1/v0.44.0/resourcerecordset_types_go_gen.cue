...
#ResourceRecordSetParameters: {
	...
	// +optional
	aliasTarget?: null | #AliasTarget @go(AliasTarget,*AliasTarget)
	...
	// +optional
	geoLocation?: null | #GeoLocation @go(GeoLocation,*GeoLocation)
	...
	// +optional
	multiValueAnswer?: null | bool @go(MultiValueAnswer,*bool)
	...
	resourceRecords?: [...#ResourceRecord] @go(ResourceRecords,[]ResourceRecord)
	...
	// no longer in use.
	// +optional
	trafficPolicyInstanceId?: null | string @go(TrafficPolicyInstanceID,*string)
...
#AliasTarget: {
	...
	// in the Amazon Route 53 Developer Guide.
	evaluateTargetHealth: bool @go(EvaluateTargetHealth)
...
#GeoLocation: {
	...
	// +optional
	continentCode?: null | string @go(ContinentCode,*string)
	...
	// +optional
	subdivisionCode?: null | string @go(SubdivisionCode,*string)
}
