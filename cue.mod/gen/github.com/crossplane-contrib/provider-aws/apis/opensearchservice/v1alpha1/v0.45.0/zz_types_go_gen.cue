...
#AutoTuneOptions: {
	...
	useOffPeakWindow?: null | bool @go(UseOffPeakWindow,*bool)
}
...
#ClusterConfig: {
	...
	multiAZWithStandbyEnabled?: null | bool                @go(MultiAZWithStandbyEnabled,*bool)
...
#DomainNodesStatus: {
	...
	storageVolumeType?: null | string @go(StorageVolumeType,*string)
}
...
#DryRunProgressStatus: {
	...
	dryRunID?:     null | string @go(DryRunID,*string)
	dryRunStatus?: null | string @go(DryRunStatus,*string)
	updateDate?:   null | string @go(UpdateDate,*string)
}
...
#OffPeakWindow: {
	...
	windowStartTime?: null | #WindowStartTime @go(WindowStartTime,*WindowStartTime)
}
...
#OffPeakWindowOptions: {
	...
	offPeakWindow?: null | #OffPeakWindow @go(OffPeakWindow,*OffPeakWindow)
}
...
#OffPeakWindowOptionsStatus: {
	...
	// during which OpenSearch Service can perform mandatory configuration changes
	// on the domain.
	options?: null | #OffPeakWindowOptions @go(Options,*OffPeakWindowOptions)
}
...
#SoftwareUpdateOptions: {
	autoSoftwareUpdateEnabled?: null | bool @go(AutoSoftwareUpdateEnabled,*bool)
}

// +kubebuilder:skipversion
#SoftwareUpdateOptionsStatus: {
	// Options for configuring service software updates for a domain.
	options?: null | #SoftwareUpdateOptions @go(Options,*SoftwareUpdateOptions)
}
...
// +kubebuilder:skipversion
#WindowStartTime: {
	hours?:   null | int64 @go(Hours,*int64)
	minutes?: null | int64 @go(Minutes,*int64)
}
