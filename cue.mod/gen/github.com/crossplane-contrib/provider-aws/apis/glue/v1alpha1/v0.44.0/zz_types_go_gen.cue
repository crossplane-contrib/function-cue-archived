...
#AmazonRedshiftNodeData: {
	...
	advancedOptions?: [...null | #AmazonRedshiftAdvancedOption] @go(AdvancedOptions,[]*AmazonRedshiftAdvancedOption)

	// Specifies an option value.
	catalogDatabase?:       null | #Option @go(CatalogDatabase,*Option)
	catalogRedshiftSchema?: null | string  @go(CatalogRedshiftSchema,*string)
	catalogRedshiftTable?:  null | string  @go(CatalogRedshiftTable,*string)

	// Specifies an option value.
	catalogTable?: null | #Option @go(CatalogTable,*Option)

	// Specifies an option value.
	connection?:        null | #Option @go(Connection,*Option)
	crawlerConnection?: null | string  @go(CrawlerConnection,*string)

	// Specifies an option value.
	iamRole?:             null | #Option @go(IAMRole,*Option)
	mergeAction?:         null | string  @go(MergeAction,*string)
	mergeClause?:         null | string  @go(MergeClause,*string)
	mergeWhenMatched?:    null | string  @go(MergeWhenMatched,*string)
	mergeWhenNotMatched?: null | string  @go(MergeWhenNotMatched,*string)
	postAction?:          null | string  @go(PostAction,*string)
	preAction?:           null | string  @go(PreAction,*string)
	sampleQuery?:         null | string  @go(SampleQuery,*string)

	// Specifies an option value.
	schema?: null | #Option @go(Schema,*Option)
	selectedColumns?: [...null | #Option] @go(SelectedColumns,[]*Option)
	sourceType?:   null | string @go(SourceType,*string)
	stagingTable?: null | string @go(StagingTable,*string)

	// Specifies an option value.
	table?:       null | #Option @go(Table,*Option)
	tablePrefix?: null | string  @go(TablePrefix,*string)
	tableSchema?: [...null | #Option] @go(TableSchema,[]*Option)
	tempDir?: null | string @go(TempDir,*string)
	upsert?:  null | bool   @go(Upsert,*bool)
}

// +kubebuilder:skipversion
#AmazonRedshiftSource: {
	// Specifies an Amazon Redshift node.
	data?: null | #AmazonRedshiftNodeData @go(Data,*AmazonRedshiftNodeData)
	name?: null | string                  @go(Name,*string)
}
...
// +kubebuilder:skipversion
#CatalogDeltaSource: {
	additionalDeltaOptions?: {[string]: null | string} @go(AdditionalDeltaOptions,map[string]*string)
	database?: null | string @go(Database,*string)
	name?:     null | string @go(Name,*string)
	outputSchemas?: [...null | #GlueSchema] @go(OutputSchemas,[]*GlueSchema)
	table?: null | string @go(Table,*string)
...
// +kubebuilder:skipversion
#CatalogHudiSource: {
	additionalHudiOptions?: {[string]: null | string} @go(AdditionalHudiOptions,map[string]*string)
	database?: null | string @go(Database,*string)
	name?:     null | string @go(Name,*string)
	outputSchemas?: [...null | #GlueSchema] @go(OutputSchemas,[]*GlueSchema)
	table?: null | string @go(Table,*string)
...
#CodeGenConfigurationNode: {
	...
	amazonRedshiftSource?: null | #AmazonRedshiftSource @go(AmazonRedshiftSource,*AmazonRedshiftSource)

	// Specifies an Amazon Redshift target.
	amazonRedshiftTarget?: null | #AmazonRedshiftTarget @go(AmazonRedshiftTarget,*AmazonRedshiftTarget)
	...
	catalogDeltaSource?: null | #CatalogDeltaSource @go(CatalogDeltaSource,*CatalogDeltaSource)

	// Specifies a Hudi data source that is registered in the Glue Data Catalog.
	catalogHudiSource?: null | #CatalogHudiSource @go(CatalogHudiSource,*CatalogHudiSource)
	...
	directJDBCSource?: null | #DirectJDBCSource @go(DirectJDBCSource,*DirectJDBCSource)
	...
	// Specifies your data quality evaluation criteria.
	evaluateDataQualityMultiFrame?: null | #EvaluateDataQualityMultiFrame @go(EvaluateDataQualityMultiFrame,*EvaluateDataQualityMultiFrame)
	...
	recipe?: null | #Recipe @go(Recipe,*Recipe)
	...
	s3CatalogDeltaSource?: null | #S3CatalogDeltaSource @go(S3CatalogDeltaSource,*S3CatalogDeltaSource)

	// Specifies a Hudi data source that is registered in the Glue Data Catalog.
	// The Hudi data source must be stored in Amazon S3.
	s3CatalogHudiSource?: null | #S3CatalogHudiSource @go(S3CatalogHudiSource,*S3CatalogHudiSource)
	...
	// Catalog.
	s3DeltaCatalogTarget?: null | #S3DeltaCatalogTarget @go(S3DeltaCatalogTarget,*S3DeltaCatalogTarget)

	// Specifies a target that writes to a Delta Lake data source in Amazon S3.
	s3DeltaDirectTarget?: null | #S3DeltaDirectTarget @go(S3DeltaDirectTarget,*S3DeltaDirectTarget)

	// Specifies a Delta Lake data source stored in Amazon S3.
	s3DeltaSource?: null | #S3DeltaSource @go(S3DeltaSource,*S3DeltaSource)
	...
	s3HudiCatalogTarget?: null | #S3HudiCatalogTarget @go(S3HudiCatalogTarget,*S3HudiCatalogTarget)

	// Specifies a target that writes to a Hudi data source in Amazon S3.
	s3HudiDirectTarget?: null | #S3HudiDirectTarget @go(S3HudiDirectTarget,*S3HudiDirectTarget)

	// Specifies a Hudi data source stored in Amazon S3.
	s3HudiSource?: null | #S3HudiSource @go(S3HudiSource,*S3HudiSource)
	...
	snowflakeSource?: null | #SnowflakeSource @go(SnowflakeSource,*SnowflakeSource)

	// Specifies a Snowflake target.
	snowflakeTarget?: null | #SnowflakeTarget @go(SnowflakeTarget,*SnowflakeTarget)
...
#CrawlerTargets: {
	...
	hudiTargets?: [...null | #HudiTarget] @go(HudiTargets,[]*HudiTarget)
	icebergTargets?: [...null | #IcebergTarget] @go(IcebergTargets,[]*IcebergTarget)
...
#CreateCsvClassifierRequest: {
	...
	serde?:       null | string @go(Serde,*string)
}
...
#DatabaseInput: {
	...
	federatedDatabase?: null | #FederatedDatabase @go(FederatedDatabase,*FederatedDatabase)
...
#EvaluateDataQualityMultiFrame: {
	additionalDataSources?: {[string]: null | string} @go(AdditionalDataSources,map[string]*string)
...
#FederatedTable: {
	connectionName?:     null | string @go(ConnectionName,*string)
	databaseIdentifier?: null | string @go(DatabaseIdentifier,*string)
	identifier?:         null | string @go(Identifier,*string)
}
...
#HudiTarget: {
	...
	maximumTraversalDepth?: null | int64 @go(MaximumTraversalDepth,*int64)
	paths?: [...null | string] @go(Paths,[]*string)
}
...
#KafkaStreamingSourceOptions: {
	addRecordTimestamp?:     null | string @go(AddRecordTimestamp,*string)
	assign?:                 null | string @go(Assign,*string)
	bootstrapServers?:       null | string @go(BootstrapServers,*string)
	classification?:         null | string @go(Classification,*string)
	connectionName?:         null | string @go(ConnectionName,*string)
	delimiter?:              null | string @go(Delimiter,*string)
	emitConsumerLagMetrics?: null | string @go(EmitConsumerLagMetrics,*string)
	endingOffsets?:          null | string @go(EndingOffsets,*string)
	includeHeaders?:         null | bool   @go(IncludeHeaders,*bool)
...
#Recipe: {
	...
	recipeReference?: null | #RecipeReference @go(RecipeReference,*RecipeReference)
}

// +kubebuilder:skipversion
#RecipeReference: {
	recipeARN?:     null | string @go(RecipeARN,*string)
	recipeVersion?: null | string @go(RecipeVersion,*string)
}
...
#Session: {
	...
	description?:           null | string           @go(Description,*string)
	errorMessage?:          null | string           @go(ErrorMessage,*string)
	executionTime?:         null | float64          @go(ExecutionTime,*float64)
	glueVersion?:           null | string           @go(GlueVersion,*string)
	id?:                    null | string           @go(ID,*string)
	maxCapacity?:           null | float64          @go(MaxCapacity,*float64)
	numberOfWorkers?:       null | int64            @go(NumberOfWorkers,*int64)
...
#SnowflakeNodeData: {
	action?: null | string @go(Action,*string)
	additionalOptions?: {[string]: null | string} @go(AdditionalOptions,map[string]*string)
	autoPushdown?: null | bool @go(AutoPushdown,*bool)
...
#SnowflakeSource: {
	...
	data?: null | #SnowflakeNodeData @go(Data,*SnowflakeNodeData)
	name?: null | string             @go(Name,*string)
	outputSchemas?: [...null | #GlueSchema] @go(OutputSchemas,[]*GlueSchema)
}
