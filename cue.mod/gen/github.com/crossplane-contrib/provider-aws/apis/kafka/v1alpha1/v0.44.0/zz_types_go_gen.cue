...
#BrokerNodeGroupInfo: {
	...
	zoneIDs?: [...null | string] @go(ZoneIDs,[]*string)
}
...
#ClientVPCConnection: {
	...
	vpcConnectionARN?: null | string @go(VPCConnectionARN,*string)
}
...
#VPCConnection: {
	authentication?:   null | string @go(Authentication,*string)
	targetClusterARN?: null | string @go(TargetClusterARN,*string)
	vpcConnectionARN?: null | string @go(VPCConnectionARN,*string)
...
// +kubebuilder:skipversion
#VPCConnectivity: {
	clientAuthentication?: null | #VPCConnectivityClientAuthentication @go(ClientAuthentication,*VPCConnectivityClientAuthentication)
}

// +kubebuilder:skipversion
#VPCConnectivityClientAuthentication: {
	sasl?: null | #VPCConnectivitySASL @go(SASL,*VPCConnectivitySASL)
	tls?:  null | #VPCConnectivityTLS  @go(TLS,*VPCConnectivityTLS)
}
...
// +kubebuilder:skipversion
#VPCConnectivitySASL: {
	iam?:   null | #VPCConnectivityIAM   @go(IAM,*VPCConnectivityIAM)
	scram?: null | #VPCConnectivitySCRAM @go(SCRAM,*VPCConnectivitySCRAM)
}
