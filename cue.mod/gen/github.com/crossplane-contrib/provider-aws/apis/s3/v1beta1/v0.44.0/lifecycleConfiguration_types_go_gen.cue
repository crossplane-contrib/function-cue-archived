...
#LifecycleRule: {
	...
	// in the Amazon Simple Storage Service Developer Guide.
	// +optional
	abortIncompleteMultipartUpload?: null | #AbortIncompleteMultipartUpload @go(AbortIncompleteMultipartUpload,*AbortIncompleteMultipartUpload)
	...
	// +optional
	expiration?: null | #LifecycleExpiration @go(Expiration,*LifecycleExpiration)

	// The Filter is used to identify objects that a Lifecycle Rule applies to.
	// A Filter must have exactly one of Prefix, Tag, or And specified.
	// +optional
	filter?: null | #LifecycleRuleFilter @go(Filter,*LifecycleRuleFilter)
	...
	// +optional
	noncurrentVersionExpiration?: null | #NoncurrentVersionExpiration @go(NoncurrentVersionExpiration,*NoncurrentVersionExpiration)
	...
	// +optional
	noncurrentVersionTransitions?: [...#NoncurrentVersionTransition] @go(NoncurrentVersionTransitions,[]NoncurrentVersionTransition)
	...
	// +optional
	transitions?: [...#Transition] @go(Transitions,[]Transition)
}
...
#AbortIncompleteMultipartUpload: {
	...
	// upload.
	daysAfterInitiation: int32 @go(DaysAfterInitiation)
}
...
#LifecycleExpiration: {
	...
	expiredObjectDeleteMarker?: bool @go(ExpiredObjectDeleteMarker)
}
...
#LifecycleRuleFilter: {
	...
	and?: null | #LifecycleRuleAndOperator @go(And,*LifecycleRuleAndOperator)
...
#NoncurrentVersionExpiration: {
	...
	// in the Amazon Simple Storage Service Developer Guide.
	noncurrentDays?: int32 @go(NoncurrentDays)
}
