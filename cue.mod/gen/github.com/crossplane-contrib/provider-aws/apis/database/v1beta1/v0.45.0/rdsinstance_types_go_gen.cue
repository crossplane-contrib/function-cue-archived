...
#CloudwatchLogsExportConfiguration: {
	...
	// +immutable
	disableLogTypes?: [...string] @go(DisableLogTypes,[]string)

	// EnableLogTypes is the list of log types to enable.
	// +immutable
	enableLogTypes?: [...string] @go(EnableLogTypes,[]string)
}
...
#RDSInstanceParameters: {
	...
	// +optional
	allocatedStorage?: null | int @go(AllocatedStorage,*int)
	...
	// +optional
	backupRetentionPeriod?: null | int @go(BackupRetentionPeriod,*int)
	...
	// in the Amazon RDS User Guide.
	dbInstanceClass: string @go(DBInstanceClass)
	...
	// +optional
	enableCloudwatchLogsExports?: [...string] @go(EnableCloudwatchLogsExports,[]string)
	...
	// in the Amazon RDS User Guide.
	// +optional
	maxAllocatedStorage?: null | int @go(MaxAllocatedStorage,*int)
	...
	// +optional
	monitoringInterval?: null | int @go(MonitoringInterval,*int)
	...
	// +optional
	performanceInsightsRetentionPeriod?: null | int @go(PerformanceInsightsRetentionPeriod,*int)
	...
	// +optional
	processorFeatures?: [...#ProcessorFeature] @go(ProcessorFeatures,[]ProcessorFeature)
	...
	// Valid Values: 0 - 15
	// +optional
	promotionTier?: null | int @go(PromotionTier,*int)
	...
	// Default: false
	// +optional
	applyModificationsImmediately?: null | bool @go(ApplyModificationsImmediately,*bool)
	...
	// +immutable
	// +optional
	cloudwatchLogsExportConfiguration?: null | #CloudwatchLogsExportConfiguration @go(CloudwatchLogsExportConfiguration,*CloudwatchLogsExportConfiguration)
	...
	useDefaultProcessorFeatures?: null | bool @go(UseDefaultProcessorFeatures,*bool)
	...
	// is false.
	// Default: false
	skipFinalSnapshotBeforeDeletion?: null | bool @go(SkipFinalSnapshotBeforeDeletion,*bool)
...
#RDSInstanceSpec: {
	forProvider: #RDSInstanceParameters @go(ForProvider)
}

// RDSInstanceState represents the state of an RDS instance.
#RDSInstanceState: string
...
#DBParameterGroupStatus: {
	...
	dbParameterGroupName?: string @go(DBParameterGroupName)
...
#DBSecurityGroupMembership: {
	...
	dbSecurityGroupName?: string @go(DBSecurityGroupName)
...
#SubnetInRDS: {
	...
	// This data type is used as an element in the following data type:
	//    * OrderableDBInstanceOption
	subnetAvailabilityZone?: #AvailabilityZone @go(SubnetAvailabilityZone)

	// SubnetIdentifier specifies the identifier of the subnet.
	subnetIdentifier?: string @go(SubnetIdentifier)
...
#DBSubnetGroupInRDS: {
	...
	dbSubnetGroupArn?: string @go(DBSubnetGroupARN)

	// DBSubnetGroupDescription provides the description of the DB subnet group.
	dbSubnetGroupDescription?: string @go(DBSubnetGroupDescription)

	// DBSubnetGroupName is the name of the DB subnet group.
	dbSubnetGroupName?: string @go(DBSubnetGroupName)

	// SubnetGroupStatus provides the status of the DB subnet group.
	subnetGroupStatus?: string @go(SubnetGroupStatus)

	// Subnets contains a list of Subnet elements.
	subnets?: [...#SubnetInRDS] @go(Subnets,[]SubnetInRDS)
...
#DomainMembership: {
	...
	iamRoleName?: string @go(IAMRoleName)
...
#OptionGroupMembership: {
	...
	optionGroupName?: string @go(OptionGroupName)
...
#PendingCloudwatchLogsExports: {
	...
	// CloudWatch Logs.
	logTypesToDisable?: [...string] @go(LogTypesToDisable,[]string)
	...
	// to CloudWatch Logs.
	logTypesToEnable?: [...string] @go(LogTypesToEnable,[]string)
}
...
#PendingModifiedValues: {
	...
	engineVersion?: string @go(EngineVersion)
	...
	// StorageType specifies the storage type to be associated with the DB instance.
	storageType?: string @go(StorageType)
}
...
#DBInstanceStatusInfo: {
	...
	statusType?: string @go(StatusType)
}
...
#RDSInstanceObservation: {
	...
	awsBackupRecoveryPointARN?: string @go(AWSBackupRecoveryPointARN)
	...
	dbInstanceStatus?: string @go(DBInstanceStatus)

	// DBInstanceArn is the Amazon Resource Name (ARN) for the DB instance.
	dbInstanceArn?: string @go(DBInstanceArn)

	// DBParameterGroups provides the list of DB parameter groups applied to this DB instance.
	dbParameterGroups?: [...#DBParameterGroupStatus] @go(DBParameterGroups,[]DBParameterGroupStatus)
	...
	dbResourceId?: string @go(DBResourceID)
	...
	domainMemberships?: [...#DomainMembership] @go(DomainMemberships,[]DomainMembership)
	...
	enabledCloudwatchLogsExports?: [...string] @go(EnabledCloudwatchLogsExports,[]string)
	...
	enhancedMonitoringResourceArn?: string @go(EnhancedMonitoringResourceArn)

	// OptionGroupMemberships provides the list of option group memberships for this DB instance.
	optionGroupMemberships?: [...#OptionGroupMembership] @go(OptionGroupMemberships,[]OptionGroupMembership)
	...
	performanceInsightsEnabled?: bool @go(PerformanceInsightsEnabled)
	...
	readReplicaDBClusterIdentifiers?: [...string] @go(ReadReplicaDBClusterIdentifiers,[]string)

	// ReadReplicaDBInstanceIdentifiers contains one or more identifiers of the Read Replicas associated with this
	// DB instance.
	readReplicaDBInstanceIdentifiers?: [...string] @go(ReadReplicaDBInstanceIdentifiers,[]string)

	// ReadReplicaSourceDBInstanceIdentifier contains the identifier of the source DB instance if this DB instance is
	// a Read Replica.
	readReplicaSourceDBInstanceIdentifier?: string @go(ReadReplicaSourceDBInstanceIdentifier)
	...
	secondaryAvailabilityZone?: string @go(SecondaryAvailabilityZone)

	// StatusInfos is the status of a Read Replica. If the instance is not a Read Replica, this
	// is blank.
	statusInfos?: [...#DBInstanceStatusInfo] @go(StatusInfos,[]DBInstanceStatusInfo)

	// VPCSecurityGroups provides a list of VPC security group elements that the DB instance belongs
	// to.
	vpcSecurityGroups?: [...#VPCSecurityGroupMembership] @go(VPCSecurityGroups,[]VPCSecurityGroupMembership)
}

// An RDSInstanceStatus represents the observed state of an RDSInstance.
#RDSInstanceStatus: {
	atProvider?: #RDSInstanceObservation @go(AtProvider)
}
...
#RDSInstance: {
	spec:    #RDSInstanceSpec   @go(Spec)
	status?: #RDSInstanceStatus @go(Status)
}

// RDSInstanceList contains a list of RDSInstance
#RDSInstanceList: {
	items: [...#RDSInstance] @go(Items,[]RDSInstance)
}
