...
#ActionsInitParameters: {
	...
	deidentify?: [...#DeidentifyInitParameters] @go(Deidentify,[]DeidentifyInitParameters)

	// Sends an email when the job completes. The email goes to IAM project owners and technical Essential Contacts.
	jobNotificationEmails?: [...#JobNotificationEmailsInitParameters] @go(JobNotificationEmails,[]JobNotificationEmailsInitParameters)
	...
	publishFindingsToCloudDataCatalog?: [...#PublishFindingsToCloudDataCatalogInitParameters] @go(PublishFindingsToCloudDataCatalog,[]PublishFindingsToCloudDataCatalogInitParameters)

	// Publish the result summary of a DlpJob to the Cloud Security Command Center.
	publishSummaryToCscc?: [...#PublishSummaryToCsccInitParameters] @go(PublishSummaryToCscc,[]PublishSummaryToCsccInitParameters)

	// Enable Stackdriver metric dlp.googleapis.com/findingCount.
	publishToStackdriver?: [...#PublishToStackdriverInitParameters] @go(PublishToStackdriver,[]PublishToStackdriverInitParameters)

	// If set, the detailed findings will be persisted to the specified OutputStorageConfig. Only a single instance of this action can be specified. Compatible with: Inspect, Risk
	// Structure is documented below.
	saveFindings?: [...#SaveFindingsInitParameters] @go(SaveFindings,[]SaveFindingsInitParameters)
}
...
#BigQueryOptionsInitParameters: {
	...
	// Structure is documented below.
	excludedFields?: [...#ExcludedFieldsInitParameters] @go(ExcludedFields,[]ExcludedFieldsInitParameters)
	...
	// Structure is documented below.
	identifyingFields?: [...#IdentifyingFieldsInitParameters] @go(IdentifyingFields,[]IdentifyingFieldsInitParameters)

	// Limit scanning only to these fields.
	// Structure is documented below.
	includedFields?: [...#IncludedFieldsInitParameters] @go(IncludedFields,[]IncludedFieldsInitParameters)
	...
	// Structure is documented below.
	tableReference?: [...#TableReferenceInitParameters] @go(TableReference,[]TableReferenceInitParameters)
}
...
#BigQueryOptionsObservation: {
	...
	// This allows you to skip inspection of entire columns which you know have no findings.
	// Structure is documented below.
	excludedFields?: [...#ExcludedFieldsObservation] @go(ExcludedFields,[]ExcludedFieldsObservation)
	...
	// Limit scanning only to these fields.
	// Structure is documented below.
	includedFields?: [...#IncludedFieldsObservation] @go(IncludedFields,[]IncludedFieldsObservation)
...
#BigQueryOptionsParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	excludedFields?: [...#ExcludedFieldsParameters] @go(ExcludedFields,[]ExcludedFieldsParameters)
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	includedFields?: [...#IncludedFieldsParameters] @go(IncludedFields,[]IncludedFieldsParameters)
...
#CloudStorageOptionsInitParameters: {
	...
	// Set of files to scan.
	// Structure is documented below.
	fileSet?: [...#FileSetInitParameters] @go(FileSet,[]FileSetInitParameters)
...
#CustomInfoTypesDictionaryCloudStoragePathInitParameters: {
...
#CustomInfoTypesDictionaryInitParameters: {
	// Newline-delimited file of words in Cloud Storage. Only a single file is accepted.
	// Structure is documented below.
	cloudStoragePath?: [...#CustomInfoTypesDictionaryCloudStoragePathInitParameters] @go(CloudStoragePath,[]CustomInfoTypesDictionaryCloudStoragePathInitParameters)

	// List of words or phrases to search for.
	// Structure is documented below.
	wordList?: [...#CustomInfoTypesDictionaryWordListInitParameters] @go(WordList,[]CustomInfoTypesDictionaryWordListInitParameters)
}
...
#CustomInfoTypesDictionaryWordListInitParameters: {
...
#CustomInfoTypesInfoTypeInitParameters: {
	...
	// Structure is documented below.
	sensitivityScore?: [...#CustomInfoTypesInfoTypeSensitivityScoreInitParameters] @go(SensitivityScore,[]CustomInfoTypesInfoTypeSensitivityScoreInitParameters)
...
#CustomInfoTypesInfoTypeObservation: {
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#CustomInfoTypesInfoTypeSensitivityScoreObservation] @go(SensitivityScore,[]CustomInfoTypesInfoTypeSensitivityScoreObservation)
...
#CustomInfoTypesInfoTypeParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	sensitivityScore?: [...#CustomInfoTypesInfoTypeSensitivityScoreParameters] @go(SensitivityScore,[]CustomInfoTypesInfoTypeSensitivityScoreParameters)
...
#CustomInfoTypesInfoTypeSensitivityScoreInitParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#CustomInfoTypesInfoTypeSensitivityScoreObservation: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#CustomInfoTypesInfoTypeSensitivityScoreParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	// +kubebuilder:validation:Optional
	score?: null | string @go(Score,*string)
...
#CustomInfoTypesRegexInitParameters: {
...
#CustomInfoTypesStoredTypeInitParameters: {
	// Specification of the field containing the timestamp of scanned items. Used for data sources like Datastore and BigQuery.
	// For BigQuery: Required to filter out rows based on the given start and end times. If not specified and the table was
	// modified between the given start and end times, the entire table will be scanned. The valid data types of the timestamp
	// field are: INTEGER, DATE, TIMESTAMP, or DATETIME BigQuery column.
...
#CustomInfoTypesSurrogateTypeInitParameters: {
}
...
#DatastoreOptionsInitParameters: {
	// A representation of a Datastore kind.
	// Structure is documented below.
	kind?: [...#KindInitParameters] @go(Kind,[]KindInitParameters)

	// Datastore partition ID. A partition ID identifies a grouping of entities. The grouping
	// is always by project and namespace, however the namespace ID may be empty.
	// Structure is documented below.
	partitionId?: [...#PartitionIDInitParameters] @go(PartitionID,[]PartitionIDInitParameters)
}
...
#DeidentifyInitParameters: {
	...
	// Structure is documented below.
	transformationConfig?: [...#TransformationConfigInitParameters] @go(TransformationConfig,[]TransformationConfigInitParameters)

	// Config for storing transformation details.
	// Structure is documented below.
	transformationDetailsStorageConfig?: [...#TransformationDetailsStorageConfigInitParameters] @go(TransformationDetailsStorageConfig,[]TransformationDetailsStorageConfigInitParameters)
}
...
#ExcludeByHotwordHotwordRegexInitParameters: {
	// The index of the submatch to extract as findings. When not specified, the entire match is returned. No more than 3 may be included.
	groupIndexes?: [...null | float64] @go(GroupIndexes,[]*float64)
...
#ExcludeByHotwordProximityInitParameters: {
...
#ExclusionRuleDictionaryCloudStoragePathInitParameters: {
	// A url representing a file or path (no wildcards) in Cloud Storage. Example: gs://[BUCKET_NAME]/dictionary.txt
	path?: null | string @go(Path,*string)
}
...
#ExclusionRuleExcludeByHotwordInitParameters: {
	// Regular expression pattern defining what qualifies as a hotword.
	// Structure is documented below.
	hotwordRegex?: [...#ExcludeByHotwordHotwordRegexInitParameters] @go(HotwordRegex,[]ExcludeByHotwordHotwordRegexInitParameters)
	...
	// Structure is documented below.
	proximity?: [...#ExcludeByHotwordProximityInitParameters] @go(Proximity,[]ExcludeByHotwordProximityInitParameters)
}
...
#ExclusionRuleExcludeInfoTypesInfoTypesInitParameters: {
	// Specification of the field containing the timestamp of scanned items. Used for data sources like Datastore and BigQuery.
	// For BigQuery: Required to filter out rows based on the given start and end times. If not specified and the table was
	// modified between the given start and end times, the entire table will be scanned. The valid data types of the timestamp
	// field are: INTEGER, DATE, TIMESTAMP, or DATETIME BigQuery column.
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreInitParameters] @go(SensitivityScore,[]ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreInitParameters)
...
#ExclusionRuleExcludeInfoTypesInfoTypesObservation: {
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreObservation] @go(SensitivityScore,[]ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreObservation)
...
#ExclusionRuleExcludeInfoTypesInfoTypesParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	sensitivityScore?: [...#ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreParameters] @go(SensitivityScore,[]ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreParameters)
...
#ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreInitParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreObservation: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#ExclusionRuleExcludeInfoTypesInfoTypesSensitivityScoreParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	// +kubebuilder:validation:Optional
	score?: null | string @go(Score,*string)
...
#ExclusionRuleExcludeInfoTypesInitParameters: {
	// List of infoTypes this rule set is applied to.
	// Structure is documented below.
	infoTypes?: [...#ExclusionRuleExcludeInfoTypesInfoTypesInitParameters] @go(InfoTypes,[]ExclusionRuleExcludeInfoTypesInfoTypesInitParameters)
}
...
#FileSetInitParameters: {
	// The regex-filtered set of files to scan.
	// Structure is documented below.
	regexFileSet?: [...#RegexFileSetInitParameters] @go(RegexFileSet,[]RegexFileSetInitParameters)
...
#HotwordRuleLikelihoodAdjustmentInitParameters: {
...
#HybridOptionsInitParameters: {
	...
	// Structure is documented below.
	tableOptions?: [...#TableOptionsInitParameters] @go(TableOptions,[]TableOptionsInitParameters)
}
...
#IdentifyingFieldsInitParameters: {
	// Specification of the field containing the timestamp of scanned items. Used for data sources like Datastore and BigQuery.
	// For BigQuery: Required to filter out rows based on the given start and end times. If not specified and the table was
	// modified between the given start and end times, the entire table will be scanned. The valid data types of the timestamp
	// field are: INTEGER, DATE, TIMESTAMP, or DATETIME BigQuery column.
...
#InspectConfigCustomInfoTypesInitParameters: {
	// Dictionary which defines the rule.
	// Structure is documented below.
	dictionary?: [...#CustomInfoTypesDictionaryInitParameters] @go(Dictionary,[]CustomInfoTypesDictionaryInitParameters)
	...
	// Structure is documented below.
	infoType?: [...#CustomInfoTypesInfoTypeInitParameters] @go(InfoType,[]CustomInfoTypesInfoTypeInitParameters)
	...
	// Structure is documented below.
	regex?: [...#CustomInfoTypesRegexInitParameters] @go(Regex,[]CustomInfoTypesRegexInitParameters)

	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#InspectConfigCustomInfoTypesSensitivityScoreInitParameters] @go(SensitivityScore,[]InspectConfigCustomInfoTypesSensitivityScoreInitParameters)

	// A reference to a StoredInfoType to use with scanning.
	// Structure is documented below.
	storedType?: [...#CustomInfoTypesStoredTypeInitParameters] @go(StoredType,[]CustomInfoTypesStoredTypeInitParameters)

	// Message for detecting output from deidentification transformations that support reversing.
	surrogateType?: [...#CustomInfoTypesSurrogateTypeInitParameters] @go(SurrogateType,[]CustomInfoTypesSurrogateTypeInitParameters)
}
...
#InspectConfigCustomInfoTypesObservation: {
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#InspectConfigCustomInfoTypesSensitivityScoreObservation] @go(SensitivityScore,[]InspectConfigCustomInfoTypesSensitivityScoreObservation)
...
#InspectConfigCustomInfoTypesParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	sensitivityScore?: [...#InspectConfigCustomInfoTypesSensitivityScoreParameters] @go(SensitivityScore,[]InspectConfigCustomInfoTypesSensitivityScoreParameters)
...
#InspectConfigCustomInfoTypesSensitivityScoreInitParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#InspectConfigCustomInfoTypesSensitivityScoreObservation: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#InspectConfigCustomInfoTypesSensitivityScoreParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	// +kubebuilder:validation:Optional
	score?: null | string @go(Score,*string)
...
#InspectConfigLimitsInitParameters: {
	// Configuration of findings limit given for specified infoTypes.
	// Structure is documented below.
	maxFindingsPerInfoType?: [...#LimitsMaxFindingsPerInfoTypeInitParameters] @go(MaxFindingsPerInfoType,[]LimitsMaxFindingsPerInfoTypeInitParameters)
...
#InspectConfigRuleSetInfoTypesInitParameters: {
	// Specification of the field containing the timestamp of scanned items. Used for data sources like Datastore and BigQuery.
	// For BigQuery: Required to filter out rows based on the given start and end times. If not specified and the table was
	// modified between the given start and end times, the entire table will be scanned. The valid data types of the timestamp
	// field are: INTEGER, DATE, TIMESTAMP, or DATETIME BigQuery column.
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#InspectConfigRuleSetInfoTypesSensitivityScoreInitParameters] @go(SensitivityScore,[]InspectConfigRuleSetInfoTypesSensitivityScoreInitParameters)
...
#InspectConfigRuleSetInfoTypesObservation: {
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#InspectConfigRuleSetInfoTypesSensitivityScoreObservation] @go(SensitivityScore,[]InspectConfigRuleSetInfoTypesSensitivityScoreObservation)
...
#InspectConfigRuleSetInfoTypesParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	sensitivityScore?: [...#InspectConfigRuleSetInfoTypesSensitivityScoreParameters] @go(SensitivityScore,[]InspectConfigRuleSetInfoTypesSensitivityScoreParameters)
...
#InspectConfigRuleSetInfoTypesSensitivityScoreInitParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#InspectConfigRuleSetInfoTypesSensitivityScoreObservation: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#InspectConfigRuleSetInfoTypesSensitivityScoreParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	// +kubebuilder:validation:Optional
	score?: null | string @go(Score,*string)
...
#InspectConfigRuleSetInitParameters: {
	// List of infoTypes this rule set is applied to.
	// Structure is documented below.
	infoTypes?: [...#InspectConfigRuleSetInfoTypesInitParameters] @go(InfoTypes,[]InspectConfigRuleSetInfoTypesInitParameters)

	// Set of rules to be applied to infoTypes. The rules are applied in order.
	// Structure is documented below.
	rules?: [...#RuleSetRulesInitParameters] @go(Rules,[]RuleSetRulesInitParameters)
}
...
#InspectJobInitParameters: {
	...
	// Structure is documented below.
	inspectConfig?: [...#InspectJobInspectConfigInitParameters] @go(InspectConfig,[]InspectJobInspectConfigInitParameters)
...
#InspectJobInspectConfigInfoTypesInitParameters: {
	// Specification of the field containing the timestamp of scanned items. Used for data sources like Datastore and BigQuery.
	// For BigQuery: Required to filter out rows based on the given start and end times. If not specified and the table was
	// modified between the given start and end times, the entire table will be scanned. The valid data types of the timestamp
	// field are: INTEGER, DATE, TIMESTAMP, or DATETIME BigQuery column.
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#InspectJobInspectConfigInfoTypesSensitivityScoreInitParameters] @go(SensitivityScore,[]InspectJobInspectConfigInfoTypesSensitivityScoreInitParameters)
...
#InspectJobInspectConfigInfoTypesObservation: {
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#InspectJobInspectConfigInfoTypesSensitivityScoreObservation] @go(SensitivityScore,[]InspectJobInspectConfigInfoTypesSensitivityScoreObservation)
...
#InspectJobInspectConfigInfoTypesParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	sensitivityScore?: [...#InspectJobInspectConfigInfoTypesSensitivityScoreParameters] @go(SensitivityScore,[]InspectJobInspectConfigInfoTypesSensitivityScoreParameters)
...
#InspectJobInspectConfigInfoTypesSensitivityScoreInitParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#InspectJobInspectConfigInfoTypesSensitivityScoreObservation: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#InspectJobInspectConfigInfoTypesSensitivityScoreParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	// +kubebuilder:validation:Optional
	score?: null | string @go(Score,*string)
...
#InspectJobInspectConfigInitParameters: {
	// Custom info types to be used. See https://cloud.google.com/dlp/docs/creating-custom-infotypes to learn more.
	// Structure is documented below.
	customInfoTypes?: [...#InspectConfigCustomInfoTypesInitParameters] @go(CustomInfoTypes,[]InspectConfigCustomInfoTypesInitParameters)
	...
	// List of infoTypes this rule set is applied to.
	// Structure is documented below.
	infoTypes?: [...#InspectJobInspectConfigInfoTypesInitParameters] @go(InfoTypes,[]InspectJobInspectConfigInfoTypesInitParameters)

	// Configuration to control the number of findings returned.
	// Structure is documented below.
	limits?: [...#InspectConfigLimitsInitParameters] @go(Limits,[]InspectConfigLimitsInitParameters)
	...
	// Structure is documented below.
	ruleSet?: [...#InspectConfigRuleSetInitParameters] @go(RuleSet,[]InspectConfigRuleSetInitParameters)
}
...
#JobNotificationEmailsInitParameters: {
}
...
#JobTriggerInitParameters: {
	...
	// Structure is documented below.
	inspectJob?: [...#InspectJobInitParameters] @go(InspectJob,[]InspectJobInitParameters)
	...
	// Structure is documented below.
	triggers?: [...#TriggersInitParameters] @go(Triggers,[]TriggersInitParameters)
}
...
#LimitsMaxFindingsPerInfoTypeInfoTypeInitParameters: {
	// Specification of the field containing the timestamp of scanned items. Used for data sources like Datastore and BigQuery.
	// For BigQuery: Required to filter out rows based on the given start and end times. If not specified and the table was
	// modified between the given start and end times, the entire table will be scanned. The valid data types of the timestamp
	// field are: INTEGER, DATE, TIMESTAMP, or DATETIME BigQuery column.
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreInitParameters] @go(SensitivityScore,[]LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreInitParameters)
...
#LimitsMaxFindingsPerInfoTypeInfoTypeObservation: {
	...
	// Optional custom sensitivity for this InfoType. This only applies to data profiling.
	// Structure is documented below.
	sensitivityScore?: [...#LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreObservation] @go(SensitivityScore,[]LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreObservation)
...
#LimitsMaxFindingsPerInfoTypeInfoTypeParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	sensitivityScore?: [...#LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreParameters] @go(SensitivityScore,[]LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreParameters)
...
#LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreInitParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreObservation: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	score?: null | string @go(Score,*string)
}

#LimitsMaxFindingsPerInfoTypeInfoTypeSensitivityScoreParameters: {
	// The sensitivity score applied to the resource.
	// Possible values are: SENSITIVITY_LOW, SENSITIVITY_MODERATE, SENSITIVITY_HIGH.
	// +kubebuilder:validation:Optional
	score?: null | string @go(Score,*string)
...
#LimitsMaxFindingsPerInfoTypeInitParameters: {
	// Type of information the findings limit applies to. Only one limit per infoType should be provided. If InfoTypeLimit does
	// not have an infoType, the DLP API applies the limit against all infoTypes that are found but not
	// specified in another InfoTypeLimit.
	// Structure is documented below.
	infoType?: [...#LimitsMaxFindingsPerInfoTypeInfoTypeInitParameters] @go(InfoType,[]LimitsMaxFindingsPerInfoTypeInfoTypeInitParameters)
...
#OutputConfigInitParameters: {
	...
	// Structure is documented below.
	table?: [...#OutputConfigTableInitParameters] @go(Table,[]OutputConfigTableInitParameters)
}
...
#OutputConfigTableInitParameters: {
...
#PublishFindingsToCloudDataCatalogInitParameters: {
}
...
#PublishSummaryToCsccInitParameters: {
}
...
#PublishToStackdriverInitParameters: {
}
...
#RuleSetRulesInitParameters: {
	// The rule that specifies conditions when findings of infoTypes specified in InspectionRuleSet are removed from results.
	// Structure is documented below.
	exclusionRule?: [...#RulesExclusionRuleInitParameters] @go(ExclusionRule,[]RulesExclusionRuleInitParameters)

	// Hotword-based detection rule.
	// Structure is documented below.
	hotwordRule?: [...#RulesHotwordRuleInitParameters] @go(HotwordRule,[]RulesHotwordRuleInitParameters)
}
...
#RulesExclusionRuleDictionaryInitParameters: {
	// Newline-delimited file of words in Cloud Storage. Only a single file is accepted.
	// Structure is documented below.
	cloudStoragePath?: [...#ExclusionRuleDictionaryCloudStoragePathInitParameters] @go(CloudStoragePath,[]ExclusionRuleDictionaryCloudStoragePathInitParameters)

	// List of words or phrases to search for.
	// Structure is documented below.
	wordList?: [...#RulesExclusionRuleDictionaryWordListInitParameters] @go(WordList,[]RulesExclusionRuleDictionaryWordListInitParameters)
}
...
#RulesExclusionRuleDictionaryWordListInitParameters: {
	// Words or phrases defining the dictionary. The dictionary must contain at least one
	// phrase and every phrase must contain at least 2 characters that are letters or digits.
	words?: [...null | string] @go(Words,[]*string)
}
...
#RulesExclusionRuleInitParameters: {
	// Dictionary which defines the rule.
	// Structure is documented below.
	dictionary?: [...#RulesExclusionRuleDictionaryInitParameters] @go(Dictionary,[]RulesExclusionRuleDictionaryInitParameters)

	// Drop if the hotword rule is contained in the proximate context.
	// Structure is documented below.
	excludeByHotword?: [...#ExclusionRuleExcludeByHotwordInitParameters] @go(ExcludeByHotword,[]ExclusionRuleExcludeByHotwordInitParameters)

	// When true, excludes type information of the findings.
	excludeInfoTypes?: [...#ExclusionRuleExcludeInfoTypesInitParameters] @go(ExcludeInfoTypes,[]ExclusionRuleExcludeInfoTypesInitParameters)
	...
	// Regular expression which defines the rule.
	// Structure is documented below.
	regex?: [...#RulesExclusionRuleRegexInitParameters] @go(Regex,[]RulesExclusionRuleRegexInitParameters)
}
...
#RulesExclusionRuleRegexInitParameters: {
	// The index of the submatch to extract as findings. When not specified, the entire match is returned. No more than 3 may be included.
	groupIndexes?: [...null | float64] @go(GroupIndexes,[]*float64)
...
#RulesHotwordRuleHotwordRegexInitParameters: {
	// The index of the submatch to extract as findings. When not specified, the entire match is returned. No more than 3 may be included.
	groupIndexes?: [...null | float64] @go(GroupIndexes,[]*float64)
...
#RulesHotwordRuleInitParameters: {
	// Regular expression pattern defining what qualifies as a hotword.
	// Structure is documented below.
	hotwordRegex?: [...#RulesHotwordRuleHotwordRegexInitParameters] @go(HotwordRegex,[]RulesHotwordRuleHotwordRegexInitParameters)

	// Likelihood adjustment to apply to all matching findings.
	// Structure is documented below.
	likelihoodAdjustment?: [...#HotwordRuleLikelihoodAdjustmentInitParameters] @go(LikelihoodAdjustment,[]HotwordRuleLikelihoodAdjustmentInitParameters)
	...
	// office using the hotword regex (xxx), where xxx is the area code in question.
	// Structure is documented below.
	proximity?: [...#RulesHotwordRuleProximityInitParameters] @go(Proximity,[]RulesHotwordRuleProximityInitParameters)
}
...
#RulesHotwordRuleProximityInitParameters: {
	// Number of characters after the finding to consider. Either this or window_before must be specified
	windowAfter?: null | float64 @go(WindowAfter,*float64)
...
#StorageConfigInitParameters: {
	...
	// Structure is documented below.
	cloudStorageOptions?: [...#CloudStorageOptionsInitParameters] @go(CloudStorageOptions,[]CloudStorageOptionsInitParameters)

	// Options defining a data set within Google Cloud Datastore.
	// Structure is documented below.
	datastoreOptions?: [...#DatastoreOptionsInitParameters] @go(DatastoreOptions,[]DatastoreOptionsInitParameters)

	// Configuration to control jobs where the content being inspected is outside of Google Cloud Platform.
	// Structure is documented below.
	hybridOptions?: [...#HybridOptionsInitParameters] @go(HybridOptions,[]HybridOptionsInitParameters)

	// Information on where to inspect
	// Structure is documented below.
	timespanConfig?: [...#TimespanConfigInitParameters] @go(TimespanConfig,[]TimespanConfigInitParameters)
}
...
#TableOptionsIdentifyingFieldsInitParameters: {
	// Specification of the field containing the timestamp of scanned items. Used for data sources like Datastore and BigQuery.
	// For BigQuery: Required to filter out rows based on the given start and end times. If not specified and the table was
	// modified between the given start and end times, the entire table will be scanned. The valid data types of the timestamp
	// field are: INTEGER, DATE, TIMESTAMP, or DATETIME BigQuery column.
...
#TableOptionsInitParameters: {
	// The columns that are the primary keys for table objects included in ContentItem. A copy of this
	// cell's value will stored alongside alongside each finding so that the finding can be traced to
	// the specific row it came from. No more than 3 may be provided.
	// Structure is documented below.
	identifyingFields?: [...#TableOptionsIdentifyingFieldsInitParameters] @go(IdentifyingFields,[]TableOptionsIdentifyingFieldsInitParameters)
}
...
#TimespanConfigInitParameters: {
	...
	// Information on where to inspect
	// Structure is documented below.
	timestampField?: [...#TimestampFieldInitParameters] @go(TimestampField,[]TimestampFieldInitParameters)
}
...
#TransformationConfigInitParameters: {
...
#TransformationDetailsStorageConfigInitParameters: {
	// The BigQuery table in which to store the output.
	// Structure is documented below.
...
#TriggersInitParameters: {
	// For use with hybrid jobs. Jobs must be manually created and finished.
	manual?: [...#ManualInitParameters] @go(Manual,[]ManualInitParameters)
...
#JobTriggerSpec: {
	...
	// autoscaler.
	initProvider?: #JobTriggerInitParameters @go(InitProvider)
}
