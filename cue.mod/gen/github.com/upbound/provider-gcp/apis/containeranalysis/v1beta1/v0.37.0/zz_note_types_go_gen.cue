...
#AttestationAuthorityInitParameters: {
	...
	hint?: [...#HintInitParameters] @go(Hint,[]HintInitParameters)
}
...
#NoteInitParameters: {
	...
	// project.
	// Structure is documented below.
	attestationAuthority?: [...#AttestationAuthorityInitParameters] @go(AttestationAuthority,[]AttestationAuthorityInitParameters)
	...
	// Structure is documented below.
	relatedUrl?: [...#RelatedURLInitParameters] @go(RelatedURL,[]RelatedURLInitParameters)
...
#NoteSpec: {
	...
	// autoscaler.
	initProvider?: #NoteInitParameters @go(InitProvider)
}
