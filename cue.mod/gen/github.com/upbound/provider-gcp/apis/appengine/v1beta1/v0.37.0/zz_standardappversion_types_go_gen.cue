...
#AutomaticScalingInitParameters: {
	...
	standardSchedulerSettings?: [...#StandardSchedulerSettingsInitParameters] @go(StandardSchedulerSettings,[]StandardSchedulerSettingsInitParameters)
}
...
#DeploymentInitParameters: {
	...
	// Zip File
	// Structure is documented below.
	zip?: [...#ZipInitParameters] @go(Zip,[]ZipInitParameters)
}
...
#HandlersInitParameters: {
	...
	// Structure is documented below.
	script?: [...#ScriptInitParameters] @go(Script,[]ScriptInitParameters)
	...
	// Structure is documented below.
	staticFiles?: [...#StaticFilesInitParameters] @go(StaticFiles,[]StaticFilesInitParameters)
...
#StandardAppVersionInitParameters: {
	// Allows App Engine second generation runtimes to access the legacy bundled services.
	appEngineApis?: null | bool @go(AppEngineApis,*bool)

	// Automatic scaling is based on request rate, response latencies, and other application metrics.
	// Structure is documented below.
	automaticScaling?: [...#AutomaticScalingInitParameters] @go(AutomaticScaling,[]AutomaticScalingInitParameters)

	// Basic scaling creates instances when your application receives requests. Each instance will be shut down when the application becomes idle. Basic scaling is ideal for work that is intermittent or driven by user activity.
	// Structure is documented below.
	basicScaling?: [...#BasicScalingInitParameters] @go(BasicScaling,[]BasicScalingInitParameters)
	...
	// Structure is documented below.
	deployment?: [...#DeploymentInitParameters] @go(Deployment,[]DeploymentInitParameters)

	// The entrypoint for the application.
	// Structure is documented below.
	entrypoint?: [...#EntrypointInitParameters] @go(Entrypoint,[]EntrypointInitParameters)
	...
	// Structure is documented below.
	handlers?: [...#HandlersInitParameters] @go(Handlers,[]HandlersInitParameters)
	...
	// Structure is documented below.
	libraries?: [...#LibrariesInitParameters] @go(Libraries,[]LibrariesInitParameters)

	// A service with manual scaling runs continuously, allowing you to perform complex initialization and rely on the state of its memory over time.
	// Structure is documented below.
	manualScaling?: [...#ManualScalingInitParameters] @go(ManualScaling,[]ManualScalingInitParameters)
	...
	// Structure is documented below.
	vpcAccessConnector?: [...#VPCAccessConnectorInitParameters] @go(VPCAccessConnector,[]VPCAccessConnectorInitParameters)
}
...
#StandardSchedulerSettingsInitParameters: {
...
#VPCAccessConnectorInitParameters: {
...
#StandardAppVersionSpec: {
	...
	// autoscaler.
	initProvider?: #StandardAppVersionInitParameters @go(InitProvider)
}
