...
#CertificateTemplateIdentityConstraintsInitParameters: {
	...
	celExpression?: [...#IdentityConstraintsCelExpressionInitParameters] @go(CelExpression,[]IdentityConstraintsCelExpressionInitParameters)
}
...
#CertificateTemplateInitParameters: {
	// Optional. A human-readable description of scenarios this template is intended for.
	description?: null | string @go(Description,*string)

	// Optional. Describes constraints on identities that may be appear in Certificates issued using this template. If this is omitted, then this template will not add restrictions on a certificate's identity.
	identityConstraints?: [...#CertificateTemplateIdentityConstraintsInitParameters] @go(IdentityConstraints,[]CertificateTemplateIdentityConstraintsInitParameters)
	...
	passthroughExtensions?: [...#PassthroughExtensionsInitParameters] @go(PassthroughExtensions,[]PassthroughExtensionsInitParameters)

	// Optional. A set of X.509 values that will be applied to all issued certificates that use this template. If the certificate request includes conflicting values for the same properties, they will be overwritten by the values defined here. If the issuing CaPool's IssuancePolicy defines conflicting baseline_values for the same properties, the certificate issuance request will fail.
	predefinedValues?: [...#PredefinedValuesInitParameters] @go(PredefinedValues,[]PredefinedValuesInitParameters)
...
#IdentityConstraintsCelExpressionInitParameters: {
	// Optional. A human-readable description of scenarios this template is intended for.
	description?: null | string @go(Description,*string)
...
#PassthroughExtensionsInitParameters: {
	...
	additionalExtensions?: [...#PassthroughExtensionsAdditionalExtensionsInitParameters] @go(AdditionalExtensions,[]PassthroughExtensionsAdditionalExtensionsInitParameters)
...
#PredefinedValuesAdditionalExtensionsInitParameters: {
	...
	objectId?: [...#PredefinedValuesAdditionalExtensionsObjectIDInitParameters] @go(ObjectID,[]PredefinedValuesAdditionalExtensionsObjectIDInitParameters)

	// Required. The value of this X.509 extension.
	value?: null | string @go(Value,*string)
}

#PredefinedValuesAdditionalExtensionsObjectIDInitParameters: {
	// Required. The parts of an OID path. The most significant parts of the path come first.
	objectIdPath?: [...null | float64] @go(ObjectIDPath,[]*float64)
}
...
#PredefinedValuesCAOptionsInitParameters: {
...
#PredefinedValuesInitParameters: {
	// Optional. Describes custom X.509 extensions.
	additionalExtensions?: [...#PredefinedValuesAdditionalExtensionsInitParameters] @go(AdditionalExtensions,[]PredefinedValuesAdditionalExtensionsInitParameters)

	// Optional. Describes Online Certificate Status Protocol (OCSP) endpoint addresses that appear in the "Authority Information Access" extension in the certificate.
	aiaOcspServers?: [...null | string] @go(AiaOcspServers,[]*string)

	// Optional. Describes options in this X509Parameters that are relevant in a CA certificate.
	caOptions?: [...#PredefinedValuesCAOptionsInitParameters] @go(CAOptions,[]PredefinedValuesCAOptionsInitParameters)

	// Optional. Indicates the intended use for keys that correspond to a certificate.
	keyUsage?: [...#PredefinedValuesKeyUsageInitParameters] @go(KeyUsage,[]PredefinedValuesKeyUsageInitParameters)

	// Optional. Describes the X.509 certificate policy object identifiers, per https://tools.ietf.org/html/rfc5280#section-4.2.1.4.
	policyIds?: [...#PredefinedValuesPolicyIdsInitParameters] @go(PolicyIds,[]PredefinedValuesPolicyIdsInitParameters)
}

#PredefinedValuesKeyUsageBaseKeyUsageInitParameters: {
...
#PredefinedValuesKeyUsageExtendedKeyUsageInitParameters: {
...
#PredefinedValuesKeyUsageInitParameters: {
	// Describes high-level ways in which a key may be used.
	baseKeyUsage?: [...#PredefinedValuesKeyUsageBaseKeyUsageInitParameters] @go(BaseKeyUsage,[]PredefinedValuesKeyUsageBaseKeyUsageInitParameters)

	// Detailed scenarios in which a key may be used.
	extendedKeyUsage?: [...#PredefinedValuesKeyUsageExtendedKeyUsageInitParameters] @go(ExtendedKeyUsage,[]PredefinedValuesKeyUsageExtendedKeyUsageInitParameters)

	// Used to describe extended key usages that are not listed in the KeyUsage.ExtendedKeyUsageOptions message.
	unknownExtendedKeyUsages?: [...#PredefinedValuesKeyUsageUnknownExtendedKeyUsagesInitParameters] @go(UnknownExtendedKeyUsages,[]PredefinedValuesKeyUsageUnknownExtendedKeyUsagesInitParameters)
}
...
#PredefinedValuesKeyUsageUnknownExtendedKeyUsagesInitParameters: {
	// Required. The parts of an OID path. The most significant parts of the path come first.
	objectIdPath?: [...null | float64] @go(ObjectIDPath,[]*float64)
}
...
#PredefinedValuesPolicyIdsInitParameters: {
	// Required. The parts of an OID path. The most significant parts of the path come first.
	objectIdPath?: [...null | float64] @go(ObjectIDPath,[]*float64)
}
...
#CertificateTemplateSpec: {
	...
	// autoscaler.
	initProvider?: #CertificateTemplateInitParameters @go(InitProvider)
}
