...
#RepositoryEventConfigInitParameters: {
	// Contains filter properties for matching Pull Requests.
	// Structure is documented below.
	pullRequest?: [...#RepositoryEventConfigPullRequestInitParameters] @go(PullRequest,[]RepositoryEventConfigPullRequestInitParameters)

	// Contains filter properties for matching git pushes.
	// Structure is documented below.
	push?: [...#RepositoryEventConfigPushInitParameters] @go(Push,[]RepositoryEventConfigPushInitParameters)

	// The resource name of the Repo API resource.
	repository?: null | string @go(Repository,*string)
}

#RepositoryEventConfigObservation: {
	// Contains filter properties for matching Pull Requests.
	// Structure is documented below.
	pullRequest?: [...#RepositoryEventConfigPullRequestObservation] @go(PullRequest,[]RepositoryEventConfigPullRequestObservation)

	// Contains filter properties for matching git pushes.
	// Structure is documented below.
	push?: [...#RepositoryEventConfigPushObservation] @go(Push,[]RepositoryEventConfigPushObservation)

	// The resource name of the Repo API resource.
	repository?: null | string @go(Repository,*string)
}

#RepositoryEventConfigParameters: {
	// Contains filter properties for matching Pull Requests.
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	pullRequest?: [...#RepositoryEventConfigPullRequestParameters] @go(PullRequest,[]RepositoryEventConfigPullRequestParameters)

	// Contains filter properties for matching git pushes.
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	push?: [...#RepositoryEventConfigPushParameters] @go(Push,[]RepositoryEventConfigPushParameters)
...
#RepositoryEventConfigPullRequestInitParameters: {
	// Regex of branches to match.
	// The syntax of the regular expressions accepted is the syntax accepted by
	// RE2 and described at https://github.com/google/re2/wiki/Syntax
	branch?: null | string @go(Branch,*string)
...
#RepositoryEventConfigPullRequestObservation: {
	// Regex of branches to match.
	// The syntax of the regular expressions accepted is the syntax accepted by
	// RE2 and described at https://github.com/google/re2/wiki/Syntax
	branch?: null | string @go(Branch,*string)
...
#RepositoryEventConfigPullRequestParameters: {
	// Regex of branches to match.
	// The syntax of the regular expressions accepted is the syntax accepted by
	// RE2 and described at https://github.com/google/re2/wiki/Syntax
	// +kubebuilder:validation:Optional
...
#RepositoryEventConfigPushInitParameters: {
	// Regex of branches to match.
	// The syntax of the regular expressions accepted is the syntax accepted by
	// RE2 and described at https://github.com/google/re2/wiki/Syntax
	branch?: null | string @go(Branch,*string)
...
#RepositoryEventConfigPushObservation: {
	// Regex of branches to match.
	// The syntax of the regular expressions accepted is the syntax accepted by
	// RE2 and described at https://github.com/google/re2/wiki/Syntax
	branch?: null | string @go(Branch,*string)
...
#RepositoryEventConfigPushParameters: {
	// Regex of branches to match.
	// The syntax of the regular expressions accepted is the syntax accepted by
	// RE2 and described at https://github.com/google/re2/wiki/Syntax
	// +kubebuilder:validation:Optional
...
#TriggerInitParameters: {
	...
	// Structure is documented below.
	repositoryEventConfig?: [...#RepositoryEventConfigInitParameters] @go(RepositoryEventConfig,[]RepositoryEventConfigInitParameters)
...
#TriggerObservation: {
	...
	// The configuration of a trigger that creates a build whenever an event from Repo API is received.
	// Structure is documented below.
	repositoryEventConfig?: [...#RepositoryEventConfigObservation] @go(RepositoryEventConfig,[]RepositoryEventConfigObservation)
...
#TriggerParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	repositoryEventConfig?: [...#RepositoryEventConfigParameters] @go(RepositoryEventConfig,[]RepositoryEventConfigParameters)
