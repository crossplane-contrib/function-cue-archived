...
#Trigger: {
	...
	// +kubebuilder:validation:XValidation:rule="self.managementPolicy == 'ObserveOnly' || has(self.forProvider.matchingCriteria)",message="matchingCriteria is a required parameter"
