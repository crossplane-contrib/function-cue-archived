...
#PushConfigInitParameters: {
	...
	noWrapper?: [...#NoWrapperInitParameters] @go(NoWrapper,[]NoWrapperInitParameters)
...
#PushConfigObservation: {
	...
	// data field as the HTTP body for delivery.
	// Structure is documented below.
	noWrapper?: [...#NoWrapperObservation] @go(NoWrapper,[]NoWrapperObservation)
...
#PushConfigParameters: {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	noWrapper?: [...#NoWrapperParameters] @go(NoWrapper,[]NoWrapperParameters)
