...
#FunctionIAMMemberInitParameters: {
...
#FunctionIAMMemberSpec: {
	forProvider: #FunctionIAMMemberParameters @go(ForProvider)
	...
	// autoscaler.
	initProvider?: #FunctionIAMMemberInitParameters @go(InitProvider)
}

// FunctionIAMMemberStatus defines the observed state of FunctionIAMMember.
#FunctionIAMMemberStatus: {
	atProvider?: #FunctionIAMMemberObservation @go(AtProvider)
}
...
#FunctionIAMMember: {
	...
	spec:    #FunctionIAMMemberSpec   @go(Spec)
	status?: #FunctionIAMMemberStatus @go(Status)
}

// FunctionIAMMemberList contains a list of FunctionIAMMembers
#FunctionIAMMemberList: {
	items: [...#FunctionIAMMember] @go(Items,[]FunctionIAMMember)
}
