...
#CredentialsInitParameters: {
	...
	publicKey?: [...#PublicKeyInitParameters] @go(PublicKey,[]PublicKeyInitParameters)
}
...
#DeviceInitParameters: {
	...
	// Structure is documented below.
	gatewayConfig?: [...#GatewayConfigInitParameters] @go(GatewayConfig,[]GatewayConfigInitParameters)
