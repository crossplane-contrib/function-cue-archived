...
#Job: {
	...
	// +kubebuilder:validation:XValidation:rule="self.managementPolicy == 'ObserveOnly' || has(self.forProvider.tempGcsLocation)",message="tempGcsLocation is a required parameter"
	// +kubebuilder:validation:XValidation:rule="self.managementPolicy == 'ObserveOnly' || has(self.forProvider.templateGcsPath)",message="templateGcsPath is a required parameter"
