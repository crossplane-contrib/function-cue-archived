...
#AppEngineVersionIAMMember: {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.versionId) || has(self.initProvider.versionId)",message="versionId is a required parameter"
