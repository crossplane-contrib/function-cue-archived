...
#SnapshotIAMMemberConditionInitParameters: {
...
#SnapshotIAMMemberInitParameters: {
	condition?: [...#SnapshotIAMMemberConditionInitParameters] @go(Condition,[]SnapshotIAMMemberConditionInitParameters)
...
#SnapshotIAMMemberSpec: {
	...
	// autoscaler.
	initProvider?: #SnapshotIAMMemberInitParameters @go(InitProvider)
}
