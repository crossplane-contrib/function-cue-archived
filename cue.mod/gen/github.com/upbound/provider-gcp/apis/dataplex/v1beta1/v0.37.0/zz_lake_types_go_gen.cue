...
#LakeInitParameters: {
	...
	metastore?: [...#MetastoreInitParameters] @go(Metastore,[]MetastoreInitParameters)
...
#LakeSpec: {
	...
	// autoscaler.
	initProvider?: #LakeInitParameters @go(InitProvider)
}
