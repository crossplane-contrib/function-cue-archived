...
#ExternalDataConfigurationInitParameters: {
	...
	metadataCacheMode?: null | string @go(MetadataCacheMode,*string)
	...
	objectMetadata?: null | string @go(ObjectMetadata,*string)

	// Additional properties to set if
	// source_format is set to "PARQUET". Structure is documented below.
	parquetOptions?: [...#ExternalDataConfigurationParquetOptionsInitParameters] @go(ParquetOptions,[]ExternalDataConfigurationParquetOptionsInitParameters)
...
#ExternalDataConfigurationObservation: {
	...
	// Additional properties to set if
	// source_format is set to "PARQUET". Structure is documented below.
	parquetOptions?: [...#ExternalDataConfigurationParquetOptionsObservation] @go(ParquetOptions,[]ExternalDataConfigurationParquetOptionsObservation)
...
#ExternalDataConfigurationParameters: {
	...
	// source_format is set to "PARQUET". Structure is documented below.
	// +kubebuilder:validation:Optional
	parquetOptions?: [...#ExternalDataConfigurationParquetOptionsParameters] @go(ParquetOptions,[]ExternalDataConfigurationParquetOptionsParameters)
...
#ExternalDataConfigurationParquetOptionsInitParameters: {
...
#ExternalDataConfigurationParquetOptionsObservation: {
	// Indicates whether to use schema inference specifically for Parquet LIST logical type.
	enableListInference?: null | bool @go(EnableListInference,*bool)
...
#ExternalDataConfigurationParquetOptionsParameters: {
	// Indicates whether to use schema inference specifically for Parquet LIST logical type.
	// +kubebuilder:validation:Optional
	enableListInference?: null | bool @go(EnableListInference,*bool)
