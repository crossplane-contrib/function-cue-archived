...
#AppConnectionInitParameters: {
	// Address of the remote application endpoint for the BeyondCorp AppConnection.
	// Structure is documented below.
	applicationEndpoint?: [...#ApplicationEndpointInitParameters] @go(ApplicationEndpoint,[]ApplicationEndpointInitParameters)
...
#ApplicationEndpointInitParameters: {
...
#AppConnectionSpec: {
	...
	// autoscaler.
	initProvider?: #AppConnectionInitParameters @go(InitProvider)
}
