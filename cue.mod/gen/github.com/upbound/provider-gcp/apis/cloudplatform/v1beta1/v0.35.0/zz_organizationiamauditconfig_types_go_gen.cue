...
#OrganizationIAMAuditConfigInitParameters: {
	auditLogConfig?: [...#AuditLogConfigInitParameters] @go(AuditLogConfig,[]AuditLogConfigInitParameters)
...
#OrganizationIAMAuditConfigSpec: {
	...
	// autoscaler.
	initProvider?: #OrganizationIAMAuditConfigInitParameters @go(InitProvider)
}
