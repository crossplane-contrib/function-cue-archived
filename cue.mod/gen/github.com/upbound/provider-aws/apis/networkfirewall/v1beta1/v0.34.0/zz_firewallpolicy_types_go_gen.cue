...
#ActionDefinitionObservation: {
	...
	publishMetricAction?: [...#PublishMetricActionObservation] @go(PublishMetricAction,[]PublishMetricActionObservation)
}
...
#FirewallPolicyEncryptionConfigurationObservation: {
...
#FirewallPolicyEncryptionConfigurationParameters: {
	// The ID of the customer managed key. You can use any of the key identifiers that KMS supports, unless you're using a key that's managed by another account. If you're using a key managed by another account, then specify the key ARN.
...
#FirewallPolicyFirewallPolicyObservation: {
	...
	statefulEngineOptions?: [...#StatefulEngineOptionsObservation] @go(StatefulEngineOptions,[]StatefulEngineOptionsObservation)

	// Set of configuration blocks containing references to the stateful rule groups that are used in the policy. See Stateful Rule Group Reference below for details.
	statefulRuleGroupReference?: [...#StatefulRuleGroupReferenceObservation] @go(StatefulRuleGroupReference,[]StatefulRuleGroupReferenceObservation)
	...
	statelessCustomAction?: [...#StatelessCustomActionObservation] @go(StatelessCustomAction,[]StatelessCustomActionObservation)
	...
	statelessRuleGroupReference?: [...#StatelessRuleGroupReferenceObservation] @go(StatelessRuleGroupReference,[]StatelessRuleGroupReferenceObservation)
}
...
#FirewallPolicyObservation: {
	...
	encryptionConfiguration?: [...#FirewallPolicyEncryptionConfigurationObservation] @go(EncryptionConfiguration,[]FirewallPolicyEncryptionConfigurationObservation)

	// A configuration block describing the rule groups and policy actions to use in the firewall policy. See Firewall Policy below for details.
	firewallPolicy?: [...#FirewallPolicyFirewallPolicyObservation] @go(FirewallPolicy,[]FirewallPolicyFirewallPolicyObservation)
...
#FirewallPolicyParameters: {
	...
	// KMS encryption configuration settings. See Encryption Configuration below for details.
	// +kubebuilder:validation:Optional
	encryptionConfiguration?: [...#FirewallPolicyEncryptionConfigurationParameters] @go(EncryptionConfiguration,[]FirewallPolicyEncryptionConfigurationParameters)
...
#StatelessCustomActionObservation: {
	...
	actionDefinition?: [...#ActionDefinitionObservation] @go(ActionDefinition,[]ActionDefinitionObservation)
