...
#ClusterObservation: {
	...
	defaultCapacityProviderStrategy?: [...#DefaultCapacityProviderStrategyObservation] @go(DefaultCapacityProviderStrategy,[]DefaultCapacityProviderStrategyObservation)

	// ARN that identifies the cluster.
	id?: null | string @go(ID,*string)

	// Configures a default Service Connect namespace. Detailed below.
	serviceConnectDefaults?: [...#ServiceConnectDefaultsObservation] @go(ServiceConnectDefaults,[]ServiceConnectDefaultsObservation)
...
#ConfigurationObservation: {
	...
	executeCommandConfiguration?: [...#ExecuteCommandConfigurationObservation] @go(ExecuteCommandConfiguration,[]ExecuteCommandConfigurationObservation)
}
