...
#InstanceObservation: {
	...
	blueGreenUpdate?: [...#BlueGreenUpdateObservation] @go(BlueGreenUpdate,[]BlueGreenUpdateObservation)
	...
	restoreToPointInTime?: [...#RestoreToPointInTimeObservation] @go(RestoreToPointInTime,[]RestoreToPointInTimeObservation)

	// Restore from a Percona Xtrabackup in S3.  See Importing Data into an Amazon RDS MySQL DB Instance
	s3Import?: [...#S3ImportObservation] @go(S3Import,[]S3ImportObservation)
