...
#PolicyObservation: {
	...
	stepScalingPolicyConfiguration?: [...#StepScalingPolicyConfigurationObservation] @go(StepScalingPolicyConfiguration,[]StepScalingPolicyConfigurationObservation)

	// Target tracking policy, requires policy_type = "TargetTrackingScaling". See supported fields below.
	targetTrackingScalingPolicyConfiguration?: [...#TargetTrackingScalingPolicyConfigurationObservation] @go(TargetTrackingScalingPolicyConfiguration,[]TargetTrackingScalingPolicyConfigurationObservation)
}
