...
#CapacityReservationSpecificationObservation: {
	...
	capacityReservationTarget?: [...#CapacityReservationTargetObservation] @go(CapacityReservationTarget,[]CapacityReservationTargetObservation)
}
...
#InstanceObservation: {
	...
	capacityReservationSpecification?: [...#CapacityReservationSpecificationObservation] @go(CapacityReservationSpecification,[]CapacityReservationSpecificationObservation)
	...
	creditSpecification?: [...#CreditSpecificationObservation] @go(CreditSpecification,[]CreditSpecificationObservation)
	...
	enclaveOptions?: [...#EnclaveOptionsObservation] @go(EnclaveOptions,[]EnclaveOptionsObservation)

	// One or more configuration blocks to customize Ephemeral (also known as "Instance Store") volumes on the instance. See Block Devices below for details. When accessing this as an attribute reference, it is a set of objects.
	ephemeralBlockDevice?: [...#InstanceEphemeralBlockDeviceObservation] @go(EphemeralBlockDevice,[]InstanceEphemeralBlockDeviceObservation)
	...
	maintenanceOptions?: [...#MaintenanceOptionsObservation] @go(MaintenanceOptions,[]MaintenanceOptionsObservation)

	// Customize the metadata options of the instance. See Metadata Options below for more details.
	metadataOptions?: [...#MetadataOptionsObservation] @go(MetadataOptions,[]MetadataOptionsObservation)

	// If true, the launched EC2 instance will have detailed monitoring enabled. (Available since v0.6.0)
	monitoring?: null | bool @go(Monitoring,*bool)

	// Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
	networkInterface?: [...#InstanceNetworkInterfaceObservation] @go(NetworkInterface,[]InstanceNetworkInterfaceObservation)
	...
	privateDnsNameOptions?: [...#PrivateDNSNameOptionsObservation] @go(PrivateDNSNameOptions,[]PrivateDNSNameOptionsObservation)
