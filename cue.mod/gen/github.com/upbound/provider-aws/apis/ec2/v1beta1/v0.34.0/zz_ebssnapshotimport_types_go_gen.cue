...
#DiskContainerObservation: {
	...
	userBucket?: [...#UserBucketObservation] @go(UserBucket,[]UserBucketObservation)
}
...
#EBSSnapshotImportObservation: {
	...
	clientData?: [...#ClientDataObservation] @go(ClientData,[]ClientDataObservation)
	...
	diskContainer?: [...#DiskContainerObservation] @go(DiskContainer,[]DiskContainerObservation)
