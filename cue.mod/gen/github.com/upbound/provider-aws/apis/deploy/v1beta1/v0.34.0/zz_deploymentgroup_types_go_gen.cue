...
#BlueGreenDeploymentConfigObservation: {
	...
	deploymentReadyOption?: [...#DeploymentReadyOptionObservation] @go(DeploymentReadyOption,[]DeploymentReadyOptionObservation)

	// Information about how instances are provisioned for a replacement environment in a blue/green deployment (documented below).
	greenFleetProvisioningOption?: [...#GreenFleetProvisioningOptionObservation] @go(GreenFleetProvisioningOption,[]GreenFleetProvisioningOptionObservation)

	// Information about whether to terminate instances in the original fleet during a blue/green deployment (documented below).
	terminateBlueInstancesOnDeploymentSuccess?: [...#TerminateBlueInstancesOnDeploymentSuccessObservation] @go(TerminateBlueInstancesOnDeploymentSuccess,[]TerminateBlueInstancesOnDeploymentSuccessObservation)
}
...
#DeploymentGroupObservation: {
	...
	alarmConfiguration?: [...#AlarmConfigurationObservation] @go(AlarmConfiguration,[]AlarmConfigurationObservation)
	...
	autoRollbackConfiguration?: [...#AutoRollbackConfigurationObservation] @go(AutoRollbackConfiguration,[]AutoRollbackConfigurationObservation)

	// Autoscaling groups associated with the deployment group.
	autoscalingGroups?: [...null | string] @go(AutoscalingGroups,[]*string)

	// Configuration block of the blue/green deployment options for a deployment group (documented below).
	blueGreenDeploymentConfig?: [...#BlueGreenDeploymentConfigObservation] @go(BlueGreenDeploymentConfig,[]BlueGreenDeploymentConfigObservation)
	...
	deploymentStyle?: [...#DeploymentStyleObservation] @go(DeploymentStyle,[]DeploymentStyleObservation)

	// Tag filters associated with the deployment group. See the AWS docs for details.
	ec2TagFilter?: [...#EC2TagFilterObservation] @go(EC2TagFilter,[]EC2TagFilterObservation)

	// Configuration block(s) of Tag filters associated with the deployment group, which are also referred to as tag groups (documented below). See the AWS docs for details.
	ec2TagSet?: [...#EC2TagSetObservation] @go(EC2TagSet,[]EC2TagSetObservation)

	// Configuration block(s) of the ECS services for a deployment group (documented below).
	ecsService?: [...#EcsServiceObservation] @go(EcsService,[]EcsServiceObservation)

	// Application name and deployment group name.
	id?: null | string @go(ID,*string)

	// Single configuration block of the load balancer to use in a blue/green deployment (documented below).
	loadBalancerInfo?: [...#LoadBalancerInfoObservation] @go(LoadBalancerInfo,[]LoadBalancerInfoObservation)

	// On premise tag filters associated with the group. See the AWS docs for details.
	onPremisesInstanceTagFilter?: [...#OnPremisesInstanceTagFilterObservation] @go(OnPremisesInstanceTagFilter,[]OnPremisesInstanceTagFilterObservation)
	...
	triggerConfiguration?: [...#TriggerConfigurationObservation] @go(TriggerConfiguration,[]TriggerConfigurationObservation)
}
...
#EC2TagSetObservation: {
	// Tag filters associated with the deployment group. See the AWS docs for details.
	ec2TagFilter?: [...#EC2TagSetEC2TagFilterObservation] @go(EC2TagFilter,[]EC2TagSetEC2TagFilterObservation)
}
...
#LoadBalancerInfoObservation: {
	...
	elbInfo?: [...#ELBInfoObservation] @go(ELBInfo,[]ELBInfoObservation)

	// The (Application/Network Load Balancer) target group to use in a deployment. Conflicts with elb_info and target_group_pair_info.
	targetGroupInfo?: [...#TargetGroupInfoObservation] @go(TargetGroupInfo,[]TargetGroupInfoObservation)

	// The (Application/Network Load Balancer) target group pair to use in a deployment. Conflicts with elb_info and target_group_info.
	targetGroupPairInfo?: [...#TargetGroupPairInfoObservation] @go(TargetGroupPairInfo,[]TargetGroupPairInfoObservation)
}
...
#TargetGroupPairInfoObservation: {
	...
	prodTrafficRoute?: [...#ProdTrafficRouteObservation] @go(ProdTrafficRoute,[]ProdTrafficRouteObservation)

	// Configuration blocks for a target group within a target group pair (documented below).
	targetGroup?: [...#TargetGroupObservation] @go(TargetGroup,[]TargetGroupObservation)

	// Configuration block for the test traffic route (documented below).
	testTrafficRoute?: [...#TestTrafficRouteObservation] @go(TestTrafficRoute,[]TestTrafficRouteObservation)
}
