...
#DeploymentConfigObservation: {
	...
	minimumHealthyHosts?: [...#MinimumHealthyHostsObservation] @go(MinimumHealthyHosts,[]MinimumHealthyHostsObservation)

	// A traffic_routing_config block. Traffic Routing Config is documented below.
	trafficRoutingConfig?: [...#TrafficRoutingConfigObservation] @go(TrafficRoutingConfig,[]TrafficRoutingConfigObservation)
}
...
#TrafficRoutingConfigObservation: {
	...
	timeBasedCanary?: [...#TimeBasedCanaryObservation] @go(TimeBasedCanary,[]TimeBasedCanaryObservation)

	// The time based linear configuration information. If type is TimeBasedCanary, use time_based_canary instead.
	timeBasedLinear?: [...#TimeBasedLinearObservation] @go(TimeBasedLinear,[]TimeBasedLinearObservation)
