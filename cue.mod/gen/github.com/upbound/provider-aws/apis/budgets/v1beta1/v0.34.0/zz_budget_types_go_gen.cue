...
#BudgetObservation: {
	...
	costFilter?: [...#CostFilterObservation] @go(CostFilter,[]CostFilterObservation)

	// Map of CostFilters key/value pairs to apply to the budget.
	costFilters?: {[string]: null | string} @go(CostFilters,map[string]*string)

	// Object containing CostTypes The types of cost included in a budget, such as tax and subscriptions.
	costTypes?: [...#CostTypesObservation] @go(CostTypes,[]CostTypesObservation)
	...
	plannedLimit?: [...#PlannedLimitObservation] @go(PlannedLimit,[]PlannedLimitObservation)
