...
#FrontdoorOriginInitParameters: {
	...
	privateLink?: [...#PrivateLinkInitParameters] @go(PrivateLink,[]PrivateLinkInitParameters)
...
#FrontdoorOriginSpec: {
	...
	// autoscaler.
	initProvider?: #FrontdoorOriginInitParameters @go(InitProvider)
}
