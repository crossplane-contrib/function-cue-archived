...
#WatcherSpec: {
	forProvider: #WatcherParameters @go(ForProvider)
	...
	// autoscaler.
	initProvider?: #WatcherInitParameters @go(InitProvider)
}

// WatcherStatus defines the observed state of Watcher.
#WatcherStatus: {
	atProvider?: #WatcherObservation @go(AtProvider)
}
...
#Watcher: {
	...
	spec:    #WatcherSpec   @go(Spec)
	status?: #WatcherStatus @go(Status)
}

// WatcherList contains a list of Watchers
#WatcherList: {
	items: [...#Watcher] @go(Items,[]Watcher)
}
