...
#SecurityGroupInitParameters: {
	...
	securityRule?: [...#SecurityRuleInitParameters] @go(SecurityRule,[]SecurityRuleInitParameters)
...
#SecurityGroupSpec: {
	...
	// autoscaler.
	initProvider?: #SecurityGroupInitParameters @go(InitProvider)
}
