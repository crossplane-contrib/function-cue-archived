...
#DNSZoneInitParameters: {
	// An soa_record block as defined below. Changing this forces a new resource to be created.
	soaRecord?: [...#SoaRecordInitParameters] @go(SoaRecord,[]SoaRecordInitParameters)
...
#DNSZoneSpec: {
	...
	// autoscaler.
	initProvider?: #DNSZoneInitParameters @go(InitProvider)
}
