...
#TrafficAnalyticsInitParameters: {
...
#WatcherFlowLogInitParameters: {
	...
	trafficAnalytics?: [...#TrafficAnalyticsInitParameters] @go(TrafficAnalytics,[]TrafficAnalyticsInitParameters)
...
#WatcherFlowLogSpec: {
	...
	// autoscaler.
	initProvider?: #WatcherFlowLogInitParameters @go(InitProvider)
}
