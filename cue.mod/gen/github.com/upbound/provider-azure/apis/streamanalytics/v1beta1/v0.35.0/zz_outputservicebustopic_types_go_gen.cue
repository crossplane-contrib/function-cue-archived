...
#OutputServiceBusTopicInitParameters: {
	...
	serialization?: [...#OutputServiceBusTopicSerializationInitParameters] @go(Serialization,[]OutputServiceBusTopicSerializationInitParameters)
...
#OutputServiceBusTopicSerializationInitParameters: {
...
#OutputServiceBusTopicSpec: {
	...
	// autoscaler.
	initProvider?: #OutputServiceBusTopicInitParameters @go(InitProvider)
}
