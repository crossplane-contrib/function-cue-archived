...
#RedisEnterpriseDatabaseInitParameters: {
	...
	module?: [...#ModuleInitParameters] @go(Module,[]ModuleInitParameters)
...
#RedisEnterpriseDatabaseSpec: {
	...
	// autoscaler.
	initProvider?: #RedisEnterpriseDatabaseInitParameters @go(InitProvider)
}
