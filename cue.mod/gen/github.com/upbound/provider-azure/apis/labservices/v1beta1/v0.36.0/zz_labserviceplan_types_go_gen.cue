...
#DefaultAutoShutdownInitParameters: {
...
#DefaultConnectionInitParameters: {
...
#LabServicePlanInitParameters: {
	...
	defaultAutoShutdown?: [...#DefaultAutoShutdownInitParameters] @go(DefaultAutoShutdown,[]DefaultAutoShutdownInitParameters)

	// A default_connection block as defined below.
	defaultConnection?: [...#DefaultConnectionInitParameters] @go(DefaultConnection,[]DefaultConnectionInitParameters)
	...
	support?: [...#SupportInitParameters] @go(Support,[]SupportInitParameters)
...
#LabServicePlanSpec: {
	...
	// autoscaler.
	initProvider?: #LabServicePlanInitParameters @go(InitProvider)
}
...
#LabServicePlan: {
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.allowedRegions) || has(self.initProvider.allowedRegions)",message="allowedRegions is a required parameter"
