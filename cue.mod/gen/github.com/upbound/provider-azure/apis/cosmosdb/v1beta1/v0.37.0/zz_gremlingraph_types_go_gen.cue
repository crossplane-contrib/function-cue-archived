...
#CompositeIndexInitParameters: {
	// One or more index blocks as defined below.
	index?: [...#IndexInitParameters] @go(Index,[]IndexInitParameters)
}
...
#ConflictResolutionPolicyInitParameters: {
...
#GremlinGraphAutoscaleSettingsInitParameters: {
...
#GremlinGraphInitParameters: {
	// An autoscale_settings block as defined below. Requires partition_key_path to be set.
	autoscaleSettings?: [...#GremlinGraphAutoscaleSettingsInitParameters] @go(AutoscaleSettings,[]GremlinGraphAutoscaleSettingsInitParameters)

	// A conflict_resolution_policy blocks as defined below. Changing this forces a new resource to be created.
	conflictResolutionPolicy?: [...#ConflictResolutionPolicyInitParameters] @go(ConflictResolutionPolicy,[]ConflictResolutionPolicyInitParameters)
	...
	indexPolicy?: [...#IndexPolicyInitParameters] @go(IndexPolicy,[]IndexPolicyInitParameters)
	...
	uniqueKey?: [...#UniqueKeyInitParameters] @go(UniqueKey,[]UniqueKeyInitParameters)
}
...
#IndexPolicyInitParameters: {
	// Indicates if the indexing policy is automatic. Defaults to true.
	automatic?: null | bool @go(Automatic,*bool)

	// One or more composite_index blocks as defined below.
	compositeIndex?: [...#CompositeIndexInitParameters] @go(CompositeIndex,[]CompositeIndexInitParameters)
	...
	spatialIndex?: [...#SpatialIndexInitParameters] @go(SpatialIndex,[]SpatialIndexInitParameters)
}
...
#GremlinGraphSpec: {
	...
	// autoscaler.
	initProvider?: #GremlinGraphInitParameters @go(InitProvider)
}
