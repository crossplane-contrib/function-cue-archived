...
#AccountInitParameters: {
	...
	analyticalStorage?: [...#AnalyticalStorageInitParameters] @go(AnalyticalStorage,[]AnalyticalStorageInitParameters)
	...
	capabilities?: [...#CapabilitiesInitParameters] @go(Capabilities,[]CapabilitiesInitParameters)

	// A capacity block as defined below.
	capacity?: [...#CapacityInitParameters] @go(Capacity,[]CapacityInitParameters)

	// Specifies a consistency_policy resource, used to define the consistency policy for this CosmosDB account.
	consistencyPolicy?: [...#ConsistencyPolicyInitParameters] @go(ConsistencyPolicy,[]ConsistencyPolicyInitParameters)
	...
	geoLocation?: [...#GeoLocationInitParameters] @go(GeoLocation,[]GeoLocationInitParameters)
...
#AnalyticalStorageInitParameters: {
...
#ConsistencyPolicyInitParameters: {
...
#Account: {
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.consistencyPolicy) || has(self.initProvider.consistencyPolicy)",message="consistencyPolicy is a required parameter"
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.geoLocation) || has(self.initProvider.geoLocation)",message="geoLocation is a required parameter"
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.location) || has(self.initProvider.location)",message="location is a required parameter"
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.offerType) || has(self.initProvider.offerType)",message="offerType is a required parameter"
