...
#MSSQLDatabaseExtendedAuditingPolicyInitParameters: {
...
#MSSQLDatabaseExtendedAuditingPolicyObservation: {
...
#MSSQLDatabaseExtendedAuditingPolicyParameters: {
	// The ID of the SQL database to set the extended auditing policy. Changing this forces a new resource to be created.
...
#MSSQLDatabaseExtendedAuditingPolicySpec: {
	forProvider: #MSSQLDatabaseExtendedAuditingPolicyParameters @go(ForProvider)
	...
	// autoscaler.
	initProvider?: #MSSQLDatabaseExtendedAuditingPolicyInitParameters @go(InitProvider)
}

// MSSQLDatabaseExtendedAuditingPolicyStatus defines the observed state of MSSQLDatabaseExtendedAuditingPolicy.
#MSSQLDatabaseExtendedAuditingPolicyStatus: {
	atProvider?: #MSSQLDatabaseExtendedAuditingPolicyObservation @go(AtProvider)
}
...
#MSSQLDatabaseExtendedAuditingPolicy: {
	spec:    #MSSQLDatabaseExtendedAuditingPolicySpec   @go(Spec)
	status?: #MSSQLDatabaseExtendedAuditingPolicyStatus @go(Status)
}

// MSSQLDatabaseExtendedAuditingPolicyList contains a list of MSSQLDatabaseExtendedAuditingPolicys
#MSSQLDatabaseExtendedAuditingPolicyList: {
	items: [...#MSSQLDatabaseExtendedAuditingPolicy] @go(Items,[]MSSQLDatabaseExtendedAuditingPolicy)
}
