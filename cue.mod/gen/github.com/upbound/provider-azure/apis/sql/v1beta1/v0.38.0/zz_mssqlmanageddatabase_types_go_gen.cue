...
#MSSQLManagedDatabaseInitParameters: {
	// A long_term_retention_policy block as defined below.
	longTermRetentionPolicy?: [...#MSSQLManagedDatabaseLongTermRetentionPolicyInitParameters] @go(LongTermRetentionPolicy,[]MSSQLManagedDatabaseLongTermRetentionPolicyInitParameters)

	// The backup retention period in days. This is how many days Point-in-Time Restore will be supported.
	shortTermRetentionDays?: null | float64 @go(ShortTermRetentionDays,*float64)
}

#MSSQLManagedDatabaseLongTermRetentionPolicyInitParameters: {
...
#MSSQLManagedDatabaseSpec: {
	...
	// autoscaler.
	initProvider?: #MSSQLManagedDatabaseInitParameters @go(InitProvider)
}
