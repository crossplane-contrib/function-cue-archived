...
#MSSQLElasticPool: {
	...
	// +kubebuilder:validation:XValidation:rule="self.managementPolicy == 'ObserveOnly' || has(self.forProvider.perDatabaseSettings)",message="perDatabaseSettings is a required parameter"
