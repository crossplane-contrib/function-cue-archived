...
#DataLakeGen2PathAceInitParameters: {
...
#DataLakeGen2PathInitParameters: {
	// One or more ace blocks as defined below to specify the entries for the ACL for the path.
	ace?: [...#DataLakeGen2PathAceInitParameters] @go(Ace,[]DataLakeGen2PathAceInitParameters)
...
#DataLakeGen2PathSpec: {
	...
	// autoscaler.
	initProvider?: #DataLakeGen2PathInitParameters @go(InitProvider)
}
