...
#AccountNetworkRulesInitParameters: {
	...
	privateLinkAccess?: [...#AccountNetworkRulesPrivateLinkAccessInitParameters] @go(PrivateLinkAccess,[]AccountNetworkRulesPrivateLinkAccessInitParameters)
...
#AccountNetworkRulesPrivateLinkAccessInitParameters: {
...
#AccountNetworkRulesSpec: {
	...
	// autoscaler.
	initProvider?: #AccountNetworkRulesInitParameters @go(InitProvider)
}
