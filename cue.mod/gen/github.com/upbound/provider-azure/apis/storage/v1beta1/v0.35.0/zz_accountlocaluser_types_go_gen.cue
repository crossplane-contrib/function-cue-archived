...
#AccountLocalUserInitParameters: {
	...
	permissionScope?: [...#PermissionScopeInitParameters] @go(PermissionScope,[]PermissionScopeInitParameters)

	// One or more ssh_authorized_key blocks as defined below.
	sshAuthorizedKey?: [...#SSHAuthorizedKeyInitParameters] @go(SSHAuthorizedKey,[]SSHAuthorizedKeyInitParameters)
...
#SSHAuthorizedKeyInitParameters: {
...
#AccountLocalUserSpec: {
	...
	// autoscaler.
	initProvider?: #AccountLocalUserInitParameters @go(InitProvider)
}
