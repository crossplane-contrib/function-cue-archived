...
#LogAnalyticsQueryPackQueryInitParameters: {
	// The additional properties that can be set for the Log Analytics Query Pack Query.
	additionalSettingsJson?: null | string @go(AdditionalSettingsJSON,*string)
...
#LogAnalyticsQueryPackQueryObservation: {
	...
	queryPackId?: null | string @go(QueryPackID,*string)
...
#LogAnalyticsQueryPackQueryParameters: {
	// The additional properties that can be set for the Log Analytics Query Pack Query.
...
#LogAnalyticsQueryPackQuerySpec: {
	forProvider: #LogAnalyticsQueryPackQueryParameters @go(ForProvider)
	...
	// autoscaler.
	initProvider?: #LogAnalyticsQueryPackQueryInitParameters @go(InitProvider)
}

// LogAnalyticsQueryPackQueryStatus defines the observed state of LogAnalyticsQueryPackQuery.
#LogAnalyticsQueryPackQueryStatus: {
	atProvider?: #LogAnalyticsQueryPackQueryObservation @go(AtProvider)
}
...
#LogAnalyticsQueryPackQuery: {
	...
	spec:    #LogAnalyticsQueryPackQuerySpec   @go(Spec)
	status?: #LogAnalyticsQueryPackQueryStatus @go(Status)
}

// LogAnalyticsQueryPackQueryList contains a list of LogAnalyticsQueryPackQuerys
#LogAnalyticsQueryPackQueryList: {
	items: [...#LogAnalyticsQueryPackQuery] @go(Items,[]LogAnalyticsQueryPackQuery)
}
