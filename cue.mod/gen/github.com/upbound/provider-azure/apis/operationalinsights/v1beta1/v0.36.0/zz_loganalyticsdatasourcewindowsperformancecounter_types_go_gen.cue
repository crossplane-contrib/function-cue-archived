...
#LogAnalyticsDataSourceWindowsPerformanceCounterInitParameters: {
...
#LogAnalyticsDataSourceWindowsPerformanceCounterSpec: {
	...
	// autoscaler.
	initProvider?: #LogAnalyticsDataSourceWindowsPerformanceCounterInitParameters @go(InitProvider)
}
