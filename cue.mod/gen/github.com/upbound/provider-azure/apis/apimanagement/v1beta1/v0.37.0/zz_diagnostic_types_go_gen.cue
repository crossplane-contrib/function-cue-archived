...
#BackendRequestDataMaskingHeadersInitParameters: {
...
#BackendRequestDataMaskingInitParameters: {
	// A headers block as defined below.
	headers?: [...#BackendRequestDataMaskingHeadersInitParameters] @go(Headers,[]BackendRequestDataMaskingHeadersInitParameters)

	// A query_params block as defined below.
	queryParams?: [...#BackendRequestDataMaskingQueryParamsInitParameters] @go(QueryParams,[]BackendRequestDataMaskingQueryParamsInitParameters)
}
...
#BackendRequestDataMaskingQueryParamsInitParameters: {
	// The data masking mode. Possible values are Mask and Hide for query_params. The only possible value is Mask for headers.
	mode?: null | string @go(Mode,*string)
...
#BackendResponseDataMaskingHeadersInitParameters: {
	// The data masking mode. Possible values are Mask and Hide for query_params. The only possible value is Mask for headers.
	mode?: null | string @go(Mode,*string)
...
#BackendResponseDataMaskingQueryParamsInitParameters: {
	// The data masking mode. Possible values are Mask and Hide for query_params. The only possible value is Mask for headers.
	mode?: null | string @go(Mode,*string)
...
#DiagnosticBackendRequestInitParameters: {
	// Number of payload bytes to log (up to 8192).
	bodyBytes?: null | float64 @go(BodyBytes,*float64)

	// A data_masking block as defined below.
	dataMasking?: [...#BackendRequestDataMaskingInitParameters] @go(DataMasking,[]BackendRequestDataMaskingInitParameters)
...
#DiagnosticBackendResponseDataMaskingInitParameters: {
	// A headers block as defined below.
	headers?: [...#BackendResponseDataMaskingHeadersInitParameters] @go(Headers,[]BackendResponseDataMaskingHeadersInitParameters)

	// A query_params block as defined below.
	queryParams?: [...#BackendResponseDataMaskingQueryParamsInitParameters] @go(QueryParams,[]BackendResponseDataMaskingQueryParamsInitParameters)
}
...
#DiagnosticBackendResponseInitParameters: {
	// Number of payload bytes to log (up to 8192).
	bodyBytes?: null | float64 @go(BodyBytes,*float64)

	// A data_masking block as defined below.
	dataMasking?: [...#DiagnosticBackendResponseDataMaskingInitParameters] @go(DataMasking,[]DiagnosticBackendResponseDataMaskingInitParameters)
...
#DiagnosticFrontendRequestDataMaskingHeadersInitParameters: {
	// The data masking mode. Possible values are Mask and Hide for query_params. The only possible value is Mask for headers.
	mode?: null | string @go(Mode,*string)
...
#DiagnosticFrontendRequestDataMaskingInitParameters: {
	// A headers block as defined below.
	headers?: [...#DiagnosticFrontendRequestDataMaskingHeadersInitParameters] @go(Headers,[]DiagnosticFrontendRequestDataMaskingHeadersInitParameters)

	// A query_params block as defined below.
	queryParams?: [...#DiagnosticFrontendRequestDataMaskingQueryParamsInitParameters] @go(QueryParams,[]DiagnosticFrontendRequestDataMaskingQueryParamsInitParameters)
}
...
#DiagnosticFrontendRequestDataMaskingQueryParamsInitParameters: {
	// The data masking mode. Possible values are Mask and Hide for query_params. The only possible value is Mask for headers.
	mode?: null | string @go(Mode,*string)
...
#DiagnosticFrontendRequestInitParameters: {
	// Number of payload bytes to log (up to 8192).
	bodyBytes?: null | float64 @go(BodyBytes,*float64)

	// A data_masking block as defined below.
	dataMasking?: [...#DiagnosticFrontendRequestDataMaskingInitParameters] @go(DataMasking,[]DiagnosticFrontendRequestDataMaskingInitParameters)
...
#DiagnosticFrontendResponseDataMaskingHeadersInitParameters: {
	// The data masking mode. Possible values are Mask and Hide for query_params. The only possible value is Mask for headers.
	mode?: null | string @go(Mode,*string)
...
#DiagnosticFrontendResponseDataMaskingInitParameters: {
	// A headers block as defined below.
	headers?: [...#DiagnosticFrontendResponseDataMaskingHeadersInitParameters] @go(Headers,[]DiagnosticFrontendResponseDataMaskingHeadersInitParameters)

	// A query_params block as defined below.
	queryParams?: [...#DiagnosticFrontendResponseDataMaskingQueryParamsInitParameters] @go(QueryParams,[]DiagnosticFrontendResponseDataMaskingQueryParamsInitParameters)
}
...
#DiagnosticFrontendResponseDataMaskingQueryParamsInitParameters: {
	// The data masking mode. Possible values are Mask and Hide for query_params. The only possible value is Mask for headers.
	mode?: null | string @go(Mode,*string)
...
#DiagnosticFrontendResponseInitParameters: {
	// Number of payload bytes to log (up to 8192).
	bodyBytes?: null | float64 @go(BodyBytes,*float64)

	// A data_masking block as defined below.
	dataMasking?: [...#DiagnosticFrontendResponseDataMaskingInitParameters] @go(DataMasking,[]DiagnosticFrontendResponseDataMaskingInitParameters)
...
#DiagnosticInitParameters: {
	// Always log errors. Send telemetry if there is an erroneous condition, regardless of sampling settings.
	alwaysLogErrors?: null | bool @go(AlwaysLogErrors,*bool)

	// A backend_request block as defined below.
	backendRequest?: [...#DiagnosticBackendRequestInitParameters] @go(BackendRequest,[]DiagnosticBackendRequestInitParameters)

	// A backend_response block as defined below.
	backendResponse?: [...#DiagnosticBackendResponseInitParameters] @go(BackendResponse,[]DiagnosticBackendResponseInitParameters)

	// A frontend_request block as defined below.
	frontendRequest?: [...#DiagnosticFrontendRequestInitParameters] @go(FrontendRequest,[]DiagnosticFrontendRequestInitParameters)

	// A frontend_response block as defined below.
	frontendResponse?: [...#DiagnosticFrontendResponseInitParameters] @go(FrontendResponse,[]DiagnosticFrontendResponseInitParameters)
...
#DiagnosticSpec: {
	...
	// autoscaler.
	initProvider?: #DiagnosticInitParameters @go(InitProvider)
}
