...
#AdditionalCapabilitiesInitParameters: {
...
#DiffDiskSettingsInitParameters: {
...
#LinuxVirtualMachineGalleryApplicationInitParameters: {
...
#LinuxVirtualMachineIdentityInitParameters: {
...
#LinuxVirtualMachineInitParameters: {
	...
	additionalCapabilities?: [...#AdditionalCapabilitiesInitParameters] @go(AdditionalCapabilities,[]AdditionalCapabilitiesInitParameters)

	// One or more admin_ssh_key blocks as defined below. Changing this forces a new resource to be created.
	adminSshKey?: [...#AdminSSHKeyInitParameters] @go(AdminSSHKey,[]AdminSSHKeyInitParameters)
	...
	bootDiagnostics?: [...#BootDiagnosticsInitParameters] @go(BootDiagnostics,[]BootDiagnosticsInitParameters)
	...
	galleryApplication?: [...#LinuxVirtualMachineGalleryApplicationInitParameters] @go(GalleryApplication,[]LinuxVirtualMachineGalleryApplicationInitParameters)

	// An identity block as defined below.
	identity?: [...#LinuxVirtualMachineIdentityInitParameters] @go(Identity,[]LinuxVirtualMachineIdentityInitParameters)
	...
	osDisk?: [...#LinuxVirtualMachineOsDiskInitParameters] @go(OsDisk,[]LinuxVirtualMachineOsDiskInitParameters)
	...
	sourceImageReference?: [...#SourceImageReferenceInitParameters] @go(SourceImageReference,[]SourceImageReferenceInitParameters)

	// A mapping of tags which should be assigned to this Virtual Machine.
	tags?: {[string]: null | string} @go(Tags,map[string]*string)

	// A termination_notification block as defined below.
	terminationNotification?: [...#TerminationNotificationInitParameters] @go(TerminationNotification,[]TerminationNotificationInitParameters)
...
#LinuxVirtualMachineOsDiskInitParameters: {
	// The Type of Caching which should be used for the Internal OS Disk. Possible values are None, ReadOnly and ReadWrite.
	caching?: null | string @go(Caching,*string)

	// A diff_disk_settings block as defined above. Changing this forces a new resource to be created.
	diffDiskSettings?: [...#DiffDiskSettingsInitParameters] @go(DiffDiskSettings,[]DiffDiskSettingsInitParameters)
...
#SourceImageReferenceInitParameters: {
...
#TerminationNotificationInitParameters: {
