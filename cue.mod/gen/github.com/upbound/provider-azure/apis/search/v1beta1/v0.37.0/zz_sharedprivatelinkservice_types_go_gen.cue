...
#SharedPrivateLinkServiceInitParameters: {
...
#SharedPrivateLinkServiceObservation: {
	...
	searchServiceId?: null | string @go(SearchServiceID,*string)
...
#SharedPrivateLinkServiceParameters: {
	// Specify the request message for requesting approval of the Shared Private Link Enabled Remote Resource.
...
#SharedPrivateLinkServiceSpec: {
	forProvider: #SharedPrivateLinkServiceParameters @go(ForProvider)
	...
	// autoscaler.
	initProvider?: #SharedPrivateLinkServiceInitParameters @go(InitProvider)
}

// SharedPrivateLinkServiceStatus defines the observed state of SharedPrivateLinkService.
#SharedPrivateLinkServiceStatus: {
	atProvider?: #SharedPrivateLinkServiceObservation @go(AtProvider)
}
...
#SharedPrivateLinkService: {
	...
	spec:    #SharedPrivateLinkServiceSpec   @go(Spec)
	status?: #SharedPrivateLinkServiceStatus @go(Status)
}

// SharedPrivateLinkServiceList contains a list of SharedPrivateLinkServices
#SharedPrivateLinkServiceList: {
	items: [...#SharedPrivateLinkService] @go(Items,[]SharedPrivateLinkService)
}
