...
#KeyVaultSASTokenInitParameters: {
...
#LinkedServiceAzureBlobStorageInitParameters: {
	...
	keyVaultSasToken?: [...#KeyVaultSASTokenInitParameters] @go(KeyVaultSASToken,[]KeyVaultSASTokenInitParameters)
	...
	servicePrincipalLinkedKeyVaultKey?: [...#ServicePrincipalLinkedKeyVaultKeyInitParameters] @go(ServicePrincipalLinkedKeyVaultKey,[]ServicePrincipalLinkedKeyVaultKeyInitParameters)
...
#ServicePrincipalLinkedKeyVaultKeyInitParameters: {
...
#LinkedServiceAzureBlobStorageSpec: {
	...
	// autoscaler.
	initProvider?: #LinkedServiceAzureBlobStorageInitParameters @go(InitProvider)
}
