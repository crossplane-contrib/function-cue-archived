...
#DataSetAzureBlobInitParameters: {
	...
	schemaColumn?: [...#SchemaColumnInitParameters] @go(SchemaColumn,[]SchemaColumnInitParameters)
}
...
#DataSetAzureBlobSpec: {
	...
	// autoscaler.
	initProvider?: #DataSetAzureBlobInitParameters @go(InitProvider)
}
