...
#LinkedServiceAzureDatabricksInitParameters: {
	...
	instancePool?: [...#InstancePoolInitParameters] @go(InstancePool,[]InstancePoolInitParameters)
	...
	keyVaultPassword?: [...#LinkedServiceAzureDatabricksKeyVaultPasswordInitParameters] @go(KeyVaultPassword,[]LinkedServiceAzureDatabricksKeyVaultPasswordInitParameters)

	// Creates new clusters within the linked ADB instance as defined in the new_cluster_config block below.
	newClusterConfig?: [...#NewClusterConfigInitParameters] @go(NewClusterConfig,[]NewClusterConfigInitParameters)

	// A map of parameters to associate with the Data Factory Linked Service.
	parameters?: {[string]: null | string} @go(Parameters,map[string]*string)
}

#LinkedServiceAzureDatabricksKeyVaultPasswordInitParameters: {
...
#NewClusterConfigInitParameters: {
	// Spark version of a the cluster.
	clusterVersion?: null | string @go(ClusterVersion,*string)
...
#LinkedServiceAzureDatabricksSpec: {
	...
	// autoscaler.
	initProvider?: #LinkedServiceAzureDatabricksInitParameters @go(InitProvider)
}
