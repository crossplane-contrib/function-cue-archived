...
#DataSetParquetAzureBlobStorageLocationInitParameters: {
...
#DataSetParquetHTTPServerLocationInitParameters: {
	// Is the filename using dynamic expression, function or system variables? Defaults to false.
	dynamicFilenameEnabled?: null | bool @go(DynamicFilenameEnabled,*bool)
...
#DataSetParquetInitParameters: {
	...
	azureBlobStorageLocation?: [...#DataSetParquetAzureBlobStorageLocationInitParameters] @go(AzureBlobStorageLocation,[]DataSetParquetAzureBlobStorageLocationInitParameters)
	...
	httpServerLocation?: [...#DataSetParquetHTTPServerLocationInitParameters] @go(HTTPServerLocation,[]DataSetParquetHTTPServerLocationInitParameters)

	// A map of parameters to associate with the Data Factory Dataset.
	parameters?: {[string]: null | string} @go(Parameters,map[string]*string)

	// A schema_column block as defined below.
	schemaColumn?: [...#DataSetParquetSchemaColumnInitParameters] @go(SchemaColumn,[]DataSetParquetSchemaColumnInitParameters)
}
...
#DataSetParquetSchemaColumnInitParameters: {
...
#DataSetParquetSpec: {
	...
	// autoscaler.
	initProvider?: #DataSetParquetInitParameters @go(InitProvider)
}
