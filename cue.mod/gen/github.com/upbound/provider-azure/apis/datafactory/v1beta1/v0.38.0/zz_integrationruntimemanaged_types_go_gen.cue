...
#IntegrationRuntimeManagedCatalogInfoInitParameters: {
...
#IntegrationRuntimeManagedCustomSetupScriptInitParameters: {
...
#IntegrationRuntimeManagedInitParameters: {
	// A catalog_info block as defined below.
	catalogInfo?: [...#IntegrationRuntimeManagedCatalogInfoInitParameters] @go(CatalogInfo,[]IntegrationRuntimeManagedCatalogInfoInitParameters)

	// A custom_setup_script block as defined below.
	customSetupScript?: [...#IntegrationRuntimeManagedCustomSetupScriptInitParameters] @go(CustomSetupScript,[]IntegrationRuntimeManagedCustomSetupScriptInitParameters)
	...
	vnetIntegration?: [...#IntegrationRuntimeManagedVnetIntegrationInitParameters] @go(VnetIntegration,[]IntegrationRuntimeManagedVnetIntegrationInitParameters)
}
...
#IntegrationRuntimeManagedVnetIntegrationInitParameters: {
...
#IntegrationRuntimeManagedSpec: {
	...
	// autoscaler.
	initProvider?: #IntegrationRuntimeManagedInitParameters @go(InitProvider)
}
